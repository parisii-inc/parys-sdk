...
var ITokenDistributor__factory = exports.ITokenDistributor__factory = /** @class */ (function () {
    function ITokenDistributor__factory() {
    }
    ITokenDistributor__factory.createInterface = function () {
        return new ethers_1.utils.Interface(_abi);
    };
    ITokenDistributor__factory.connect = function (address, signerOrProvider) {
        return new ethers_1.Contract(address, _abi, signerOrProvider);
    };
    ITokenDistributor__factory.abi = _abi;
    return ITokenDistributor__factory;
}());
//# sourceMappingURL=ITokenDistributor__factory.js.map