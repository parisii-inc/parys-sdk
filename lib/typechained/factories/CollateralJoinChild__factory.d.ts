...
import type { CollateralJoinChild, CollateralJoinChildInterface } from "../CollateralJoinChild";
export declare class CollateralJoinChild__factory {
    ...
    static createInterface(): CollateralJoinChildInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): CollateralJoinChild;
}
