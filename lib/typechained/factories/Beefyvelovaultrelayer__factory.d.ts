...
import type { Beefyvelovaultrelayer, BeefyvelovaultrelayerInterface } from "../Beefyvelovaultrelayer";
export declare class Beefyvelovaultrelayer__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): Beefyvelovaultrelayer;
}
