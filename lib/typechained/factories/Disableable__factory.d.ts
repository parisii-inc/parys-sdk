...
import type { Disableable, DisableableInterface } from "../Disableable";
export declare class Disableable__factory {
    ...
    static createInterface(): DisableableInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): Disableable;
}
