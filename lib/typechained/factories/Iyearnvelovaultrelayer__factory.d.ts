...
import type { Iyearnvelovaultrelayer, IyearnvelovaultrelayerInterface } from "../Iyearnvelovaultrelayer";
export declare class Iyearnvelovaultrelayer__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): Iyearnvelovaultrelayer;
}
