...
import type { Accountingjob, AccountingjobInterface } from "../Accountingjob";
export declare class Accountingjob__factory {
    ...
    static createInterface(): AccountingjobInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): Accountingjob;
}
