...
import type { Stakingmanager, StakingmanagerInterface } from "../Stakingmanager";
export declare class Stakingmanager__factory {
    static readonly abi: readonly [{
        ...
        readonly inputs: readonly [];
        readonly outputs: readonly [{
            readonly name: "_stakingManagerParams";
            readonly type: "tuple";
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): Stakingmanager;
}
