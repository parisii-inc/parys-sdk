...
import type { IRewardPoolFactory, IRewardPoolFactoryInterface } from "../IRewardPoolFactory";
export declare class IRewardPoolFactory__factory {
    ...
    static createInterface(): IRewardPoolFactoryInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): IRewardPoolFactory;
}
