...
import type { ICollateralJoinDelegatableChild, ICollateralJoinDelegatableChildInterface } from "../ICollateralJoinDelegatableChild";
export declare class ICollateralJoinDelegatableChild__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): ICollateralJoinDelegatableChild;
}
