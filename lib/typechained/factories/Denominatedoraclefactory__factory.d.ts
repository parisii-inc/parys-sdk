...
import type { Denominatedoraclefactory, DenominatedoraclefactoryInterface } from "../Denominatedoraclefactory";
export declare class Denominatedoraclefactory__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): Denominatedoraclefactory;
}
