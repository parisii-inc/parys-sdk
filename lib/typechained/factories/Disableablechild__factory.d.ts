...
import type { Disableablechild, DisableablechildInterface } from "../Disableablechild";
export declare class Disableablechild__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): Disableablechild;
}
