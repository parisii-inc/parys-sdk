...
import type { Idelayedoraclefactory, IdelayedoraclefactoryInterface } from "../Idelayedoraclefactory";
export declare class Idelayedoraclefactory__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): Idelayedoraclefactory;
}
