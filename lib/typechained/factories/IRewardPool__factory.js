...
var IRewardPool__factory = exports.IRewardPool__factory = /** @class */ (function () {
    function IRewardPool__factory() {
    }
    IRewardPool__factory.createInterface = function () {
        return new ethers_1.utils.Interface(_abi);
    };
    IRewardPool__factory.connect = function (address, signerOrProvider) {
        return new ethers_1.Contract(address, _abi, signerOrProvider);
    };
    IRewardPool__factory.abi = _abi;
    return IRewardPool__factory;
}());
//# sourceMappingURL=IRewardPool__factory.js.map