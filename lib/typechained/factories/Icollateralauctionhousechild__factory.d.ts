...
import type { Icollateralauctionhousechild, IcollateralauctionhousechildInterface } from "../Icollateralauctionhousechild";
export declare class Icollateralauctionhousechild__factory {
    ...
    static createInterface(): IcollateralauctionhousechildInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): Icollateralauctionhousechild;
}
