...
import type { Collateralauctionhousechild, CollateralauctionhousechildInterface } from "../Collateralauctionhousechild";
export declare class Collateralauctionhousechild__factory {
    ...
    static createInterface(): CollateralauctionhousechildInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): Collateralauctionhousechild;
}
