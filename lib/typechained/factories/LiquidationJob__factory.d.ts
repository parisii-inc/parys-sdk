...
import type { LiquidationJob, LiquidationJobInterface } from "../LiquidationJob";
export declare class LiquidationJob__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): LiquidationJob;
}
