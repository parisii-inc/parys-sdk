...
import type { Istabilityfeetreasury, IstabilityfeetreasuryInterface } from "../Istabilityfeetreasury";
export declare class Istabilityfeetreasury__factory {
    static readonly abi: readonly [{
        ...
        readonly inputs: readonly [];
        readonly outputs: readonly [{
            readonly name: "_treasuryCapacity";
            readonly type: "uint256";
            readonly internalType: "uint256";
        }, {
            readonly name: "_pullFundsMinThreshold";
            readonly type: "uint256";
            readonly internalType: "uint256";
        }, {
            readonly name: "_surplusTransferDelay";
            readonly type: "uint256";
            readonly internalType: "uint256";
        }];
        readonly stateMutability: "view";
        ...
        readonly inputs: readonly [];
        readonly outputs: readonly [{
            readonly name: "_latestSurplusTransferTime";
            readonly type: "uint256";
            readonly internalType: "uint256";
        }];
        readonly stateMutability: "view";
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): Istabilityfeetreasury;
}
