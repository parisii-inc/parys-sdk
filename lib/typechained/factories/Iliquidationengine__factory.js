...
var Iliquidationengine__factory = exports.Iliquidationengine__factory = /** @class */ (function () {
    function Iliquidationengine__factory() {
    }
    Iliquidationengine__factory.createInterface = function () {
        return new ethers_1.utils.Interface(_abi);
    };
    Iliquidationengine__factory.connect = function (address, signerOrProvider) {
        return new ethers_1.Contract(address, _abi, signerOrProvider);
    };
    Iliquidationengine__factory.abi = _abi;
    return Iliquidationengine__factory;
}());
//# sourceMappingURL=Iliquidationengine__factory.js.map