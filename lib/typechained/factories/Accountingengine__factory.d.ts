...
import type { Accountingengine, AccountingengineInterface } from "../Accountingengine";
export declare class Accountingengine__factory {
    static readonly abi: readonly [{
        ...
        readonly inputs: readonly [{
            ...
            readonly name: "_accEngineParams";
            readonly type: "tuple";
        ...
        readonly inputs: readonly [];
        readonly outputs: readonly [{
            readonly name: "__unqueuedUnauctionedDebt";
            readonly type: "uint256";
            readonly internalType: "uint256";
        }];
        readonly stateMutability: "view";
    ...
    static createInterface(): AccountingengineInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): Accountingengine;
}
