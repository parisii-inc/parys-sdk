...
import type { CollateralJoin, CollateralJoinInterface } from "../CollateralJoin";
export declare class CollateralJoin__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): CollateralJoin;
}
