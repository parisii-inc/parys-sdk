...
import type { Ibeefyvelovaultrelayer, IbeefyvelovaultrelayerInterface } from "../Ibeefyvelovaultrelayer";
export declare class Ibeefyvelovaultrelayer__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): Ibeefyvelovaultrelayer;
}
