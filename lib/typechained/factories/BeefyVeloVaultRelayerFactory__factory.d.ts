...
import type { BeefyVeloVaultRelayerFactory, BeefyVeloVaultRelayerFactoryInterface } from "../BeefyVeloVaultRelayerFactory";
export declare class BeefyVeloVaultRelayerFactory__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): BeefyVeloVaultRelayerFactory;
}
