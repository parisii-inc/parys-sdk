...
import type { Idelayedoracle, IdelayedoracleInterface } from "../Idelayedoracle";
export declare class Idelayedoracle__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): Idelayedoracle;
}
