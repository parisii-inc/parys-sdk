...
import type { Collateralauctionhousefactory, CollateralauctionhousefactoryInterface } from "../Collateralauctionhousefactory";
export declare class Collateralauctionhousefactory__factory {
    static readonly abi: readonly [{
        ...
        readonly inputs: readonly [];
        readonly outputs: readonly [{
            readonly name: "_collateralAuctionHousesList";
            readonly type: "address[]";
            readonly internalType: "address[]";
        }];
        readonly stateMutability: "view";
    ...
    static createInterface(): CollateralauctionhousefactoryInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): Collateralauctionhousefactory;
}
