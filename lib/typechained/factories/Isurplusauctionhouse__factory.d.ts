...
import type { Isurplusauctionhouse, IsurplusauctionhouseInterface } from "../Isurplusauctionhouse";
export declare class Isurplusauctionhouse__factory {
    static readonly abi: readonly [{
        ...
        readonly outputs: readonly [{
            ...
            readonly name: "_bidReceiver";
            readonly type: "address";
            readonly internalType: "address";
        }, {
            readonly name: "_recyclingPercentage";
            readonly type: "uint256";
            readonly internalType: "uint256";
        }];
        readonly stateMutability: "view";
        ...
        readonly inputs: readonly [];
        readonly outputs: readonly [{
            readonly name: "_sahParams";
            readonly type: "tuple";
            readonly internalType: "struct ISurplusAuctionHouse.SurplusAuctionHouseParams";
            readonly components: readonly [{
                ...
                readonly name: "bidReceiver";
                readonly type: "address";
                readonly internalType: "address";
            }, {
                readonly name: "recyclingPercentage";
                readonly type: "uint256";
                readonly internalType: "uint256";
            }];
        }];
        ...
        readonly type: "error";
        readonly name: "SAH_NullProtTokenReceiver";
        readonly inputs: readonly [];
    }, {
        readonly type: "error";
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): Isurplusauctionhouse;
}
