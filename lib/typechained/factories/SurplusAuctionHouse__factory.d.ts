...
import type { SurplusAuctionHouse, SurplusAuctionHouseInterface } from "../SurplusAuctionHouse";
export declare class SurplusAuctionHouse__factory {
    ...
    static createInterface(): SurplusAuctionHouseInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): SurplusAuctionHouse;
}
