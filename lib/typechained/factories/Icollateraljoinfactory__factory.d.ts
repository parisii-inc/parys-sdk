...
import type { Icollateraljoinfactory, IcollateraljoinfactoryInterface } from "../Icollateraljoinfactory";
export declare class Icollateraljoinfactory__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): Icollateraljoinfactory;
}
