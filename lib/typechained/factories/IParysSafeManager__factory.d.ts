...
import type { IParysSafeManager, IParysSafeManagerInterface } from "../IParysSafeManager";
export declare class IParysSafeManager__factory {
    ...
    static createInterface(): IParysSafeManagerInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): IParysSafeManager;
}
