...
import type { Debtauctionhouse, DebtauctionhouseInterface } from "../Debtauctionhouse";
export declare class Debtauctionhouse__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): Debtauctionhouse;
}
