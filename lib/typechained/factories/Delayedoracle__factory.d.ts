...
import type { Delayedoracle, DelayedoracleInterface } from "../Delayedoracle";
export declare class Delayedoracle__factory {
    ...
    static createInterface(): DelayedoracleInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): Delayedoracle;
}
