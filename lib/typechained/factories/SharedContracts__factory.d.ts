...
import type { SharedContracts, SharedContractsInterface } from "../SharedContracts";
export declare class SharedContracts__factory {
    ...
    static createInterface(): SharedContractsInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): SharedContracts;
}
