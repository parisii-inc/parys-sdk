...
import type { IPostSettlementSurplusAuctionHouse, IPostSettlementSurplusAuctionHouseInterface } from "../IPostSettlementSurplusAuctionHouse";
export declare class IPostSettlementSurplusAuctionHouse__factory {
    ...
    static createInterface(): IPostSettlementSurplusAuctionHouseInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): IPostSettlementSurplusAuctionHouse;
}
