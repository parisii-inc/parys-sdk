...
import type { Irewardpoolchild, IrewardpoolchildInterface } from "../Irewardpoolchild";
export declare class Irewardpoolchild__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): Irewardpoolchild;
}
