...
import type { Collateraljoindelegatablechild, CollateraljoindelegatablechildInterface } from "../Collateraljoindelegatablechild";
export declare class Collateraljoindelegatablechild__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): Collateraljoindelegatablechild;
}
