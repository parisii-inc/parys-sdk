...
import type { DenominatedOracleChild, DenominatedOracleChildInterface } from "../DenominatedOracleChild";
export declare class DenominatedOracleChild__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): DenominatedOracleChild;
}
