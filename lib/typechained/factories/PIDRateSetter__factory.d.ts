...
import type { PIDRateSetter, PIDRateSetterInterface } from "../PIDRateSetter";
export declare class PIDRateSetter__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): PIDRateSetter;
}
