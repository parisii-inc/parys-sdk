...
import type { TaxCollector, TaxCollectorInterface } from "../TaxCollector";
export declare class TaxCollector__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): TaxCollector;
}
