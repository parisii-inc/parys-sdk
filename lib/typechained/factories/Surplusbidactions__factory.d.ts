...
import type { Surplusbidactions, SurplusbidactionsInterface } from "../Surplusbidactions";
export declare class Surplusbidactions__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): Surplusbidactions;
}
