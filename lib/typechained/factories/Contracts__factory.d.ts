...
import type { Contracts, ContractsInterface } from "../Contracts";
export declare class Contracts__factory {
    ...
    static createInterface(): ContractsInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): Contracts;
}
