...
import type { IDisableable, IDisableableInterface } from "../IDisableable";
export declare class IDisableable__factory {
    ...
    static createInterface(): IDisableableInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): IDisableable;
}
