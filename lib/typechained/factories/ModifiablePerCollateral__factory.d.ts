...
import type { ModifiablePerCollateral, ModifiablePerCollateralInterface } from "../ModifiablePerCollateral";
export declare class ModifiablePerCollateral__factory {
    ...
    static createInterface(): ModifiablePerCollateralInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): ModifiablePerCollateral;
}
