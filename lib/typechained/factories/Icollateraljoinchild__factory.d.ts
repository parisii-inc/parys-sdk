...
import type { Icollateraljoinchild, IcollateraljoinchildInterface } from "../Icollateraljoinchild";
export declare class Icollateraljoinchild__factory {
    ...
    static createInterface(): IcollateraljoinchildInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): Icollateraljoinchild;
}
