...
import type { IModifiablePerCollateral, IModifiablePerCollateralInterface } from "../IModifiablePerCollateral";
export declare class IModifiablePerCollateral__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): IModifiablePerCollateral;
}
