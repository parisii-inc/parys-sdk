...
import type { ISettlementSurplusAuctioneer, ISettlementSurplusAuctioneerInterface } from "../ISettlementSurplusAuctioneer";
export declare class ISettlementSurplusAuctioneer__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): ISettlementSurplusAuctioneer;
}
