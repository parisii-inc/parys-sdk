...
import type { IBeefyVeloVaultRelayerChild, IBeefyVeloVaultRelayerChildInterface } from "../IBeefyVeloVaultRelayerChild";
export declare class IBeefyVeloVaultRelayerChild__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): IBeefyVeloVaultRelayerChild;
}
