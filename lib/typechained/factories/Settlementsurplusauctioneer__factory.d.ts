...
import type { Settlementsurplusauctioneer, SettlementsurplusauctioneerInterface } from "../Settlementsurplusauctioneer";
export declare class Settlementsurplusauctioneer__factory {
    static readonly abi: readonly [{
        ...
        readonly inputs: readonly [{
            ...
            readonly name: "_lastSurplusAuctionTime";
            readonly type: "uint256";
            readonly indexed: false;
            readonly internalType: "uint256";
        }, {
        ...
        readonly type: "error";
        readonly name: "SSA_AccountingEngineStillEnabled";
        readonly inputs: readonly [];
    }, {
        readonly type: "error";
        readonly name: "SSA_SurplusAuctionDelayNotPassed";
        readonly inputs: readonly [];
    }, {
        readonly type: "error";
    ...
    static createInterface(): SettlementsurplusauctioneerInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): Settlementsurplusauctioneer;
}
