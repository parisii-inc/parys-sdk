...
import type { ChainlinkRelayer, ChainlinkRelayerInterface } from "../ChainlinkRelayer";
export declare class ChainlinkRelayer__factory {
    ...
    static createInterface(): ChainlinkRelayerInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): ChainlinkRelayer;
}
