...
export interface Mockuniswapv3factoryInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "createPool" | "enableFeeAmount" | "feeAmountTickSpacing" | "getPool" | "owner"): FunctionFragment;
...
export interface Mockuniswapv3factory extends BaseContract {
    ...
    functions: {
        createPool(_tokenA: string, _tokenB: string, _fee: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        enableFeeAmount(arg0: BigNumberish, arg1: BigNumberish, overrides?: CallOverrides): Promise<[void]>;
        feeAmountTickSpacing(arg0: BigNumberish, overrides?: CallOverrides): Promise<[number] & {
            _tickSpacing: number;
        }>;
        getPool(_tokenA: string, _tokenB: string, _fee: BigNumberish, overrides?: CallOverrides): Promise<[string] & {
            _pool: string;
        }>;
    ...
    owner(overrides?: CallOverrides): Promise<string>;
    callStatic: {
        createPool(_tokenA: string, _tokenB: string, _fee: BigNumberish, overrides?: CallOverrides): Promise<string>;
        enableFeeAmount(arg0: BigNumberish, arg1: BigNumberish, overrides?: CallOverrides): Promise<void>;
        feeAmountTickSpacing(arg0: BigNumberish, overrides?: CallOverrides): Promise<number>;
        getPool(_tokenA: string, _tokenB: string, _fee: BigNumberish, overrides?: CallOverrides): Promise<string>;
        owner(overrides?: CallOverrides): Promise<string>;
    ...
    estimateGas: {
        ...
        enableFeeAmount(arg0: BigNumberish, arg1: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        feeAmountTickSpacing(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getPool(_tokenA: string, _tokenB: string, _fee: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        enableFeeAmount(arg0: BigNumberish, arg1: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        feeAmountTickSpacing(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getPool(_tokenA: string, _tokenB: string, _fee: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
