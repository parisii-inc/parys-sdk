...
export interface MockchainlinksequencerInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "decimals" | "description" | "getRoundData" | "latestRoundData" | "setIsDown" | "version"): FunctionFragment;
...
export interface Mockchainlinksequencer extends BaseContract {
    ...
    functions: {
        ...
        setIsDown(_newIsDown: boolean, overrides?: Overrides & {
            from?: string;
