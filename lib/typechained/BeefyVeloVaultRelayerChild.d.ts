...
export interface BeefyVeloVaultRelayerChildInterface extends utils.Interface {
    functions: {
...
export interface BeefyVeloVaultRelayerChild extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BeefyVeloVaultRelayerChildInterface;
