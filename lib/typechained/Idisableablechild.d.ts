...
export interface IdisableablechildInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addAuthorization" | "authorizedAccounts(address)" | "authorizedAccounts()" | "contractEnabled" | "disableContract" | "factory" | "removeAuthorization"): FunctionFragment;
...
export interface Idisableablechild extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IdisableablechildInterface;
