...
export interface CollateralAuctionHouseChildInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "AUCTION_HOUSE_TYPE" | "_auctions" | "_params" | "addAuthorization" | "auctions" | "auctionsStarted" | "authorizedAccounts(address)" | "authorizedAccounts()" | "buyCollateral" | "collateralType" | "contractEnabled" | "disableContract" | "factory" | "getAuctionDiscount" | "getCollateralBought" | "liquidationEngine" | "modifyParameters" | "oracleRelayer" | "params" | "removeAuthorization" | "safeEngine" | "startAuction" | "terminateAuctionPrematurely"): FunctionFragment;
...
export interface CollateralAuctionHouseChild extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CollateralAuctionHouseChildInterface;
    ...
    functions: {
        ...
        startAuction(_forgoneCollateralReceiver: string, _auctionIncomeRecipient: string, _amountToRaise: BigNumberish, _amountToSell: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        safeEngine(overrides?: CallOverrides): Promise<string>;
        startAuction(_forgoneCollateralReceiver: string, _auctionIncomeRecipient: string, _amountToRaise: BigNumberish, _amountToSell: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
