...
export interface IstabilityfeetreasuryInterface extends utils.Interface {
    functions: {
...
export interface Istabilityfeetreasury extends BaseContract {
    ...
    functions: {
        ...
        _params(overrides?: CallOverrides): Promise<[
            ...
            _treasuryCapacity: BigNumber;
            _pullFundsMinThreshold: BigNumber;
            _surplusTransferDelay: BigNumber;
        }>;
        ...
        latestSurplusTransferTime(overrides?: CallOverrides): Promise<[BigNumber] & {
            _latestSurplusTransferTime: BigNumber;
        }>;
