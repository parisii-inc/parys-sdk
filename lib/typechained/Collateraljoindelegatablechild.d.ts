...
export interface CollateraljoindelegatablechildInterface extends utils.Interface {
    functions: {
...
export interface Collateraljoindelegatablechild extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CollateraljoindelegatablechildInterface;
