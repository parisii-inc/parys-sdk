...
export interface IChainlinkRelayerChildInterface extends utils.Interface {
    functions: {
...
export interface IChainlinkRelayerChild extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IChainlinkRelayerChildInterface;
