...
export declare namespace IAccountingEngine {
    type AccountingEngineParamsStruct = {
    ...
    type AccountingEngineParamsStructOutput = [
        BigNumber,
        BigNumber,
        BigNumber,
        BigNumber,
...
export interface IaccountingengineInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "_params" | "addAuthorization" | "auctionDebt" | "auctionSurplus" | "authorizedAccounts(address)" | "authorizedAccounts()" | "cancelAuctionedDebtWithSurplus" | "contractEnabled" | "debtAuctionHouse" | "debtQueue" | "disableContract" | "disableTimestamp" | "extraSurplusReceiver" | "lastSurplusTime" | "modifyParameters" | "params" | "popDebtFromQueue" | "postSettlementSurplusDrain" | "pushDebtToQueue" | "removeAuthorization" | "safeEngine" | "settleDebt" | "surplusAuctionHouse" | "totalOnAuctionDebt" | "totalQueuedDebt" | "transferExtraSurplus" | "transferPostSettlementSurplus" | "unqueuedUnauctionedDebt"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "auctionDebt", values?: undefined): string;
    encodeFunctionData(functionFragment: "auctionSurplus", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "cancelAuctionedDebtWithSurplus", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "contractEnabled", values?: undefined): string;
    encodeFunctionData(functionFragment: "debtAuctionHouse", values?: undefined): string;
    encodeFunctionData(functionFragment: "debtQueue", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "disableContract", values?: undefined): string;
    encodeFunctionData(functionFragment: "disableTimestamp", values?: undefined): string;
    encodeFunctionData(functionFragment: "extraSurplusReceiver", values?: undefined): string;
    encodeFunctionData(functionFragment: "lastSurplusTime", values?: undefined): string;
    encodeFunctionData(functionFragment: "modifyParameters", values: [BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "params", values?: undefined): string;
    encodeFunctionData(functionFragment: "popDebtFromQueue", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "postSettlementSurplusDrain", values?: undefined): string;
    encodeFunctionData(functionFragment: "pushDebtToQueue", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "surplusAuctionHouse", values?: undefined): string;
    encodeFunctionData(functionFragment: "totalOnAuctionDebt", values?: undefined): string;
    encodeFunctionData(functionFragment: "totalQueuedDebt", values?: undefined): string;
    encodeFunctionData(functionFragment: "transferExtraSurplus", values?: undefined): string;
    encodeFunctionData(functionFragment: "transferPostSettlementSurplus", values?: undefined): string;
    encodeFunctionData(functionFragment: "unqueuedUnauctionedDebt", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "auctionDebt", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "auctionSurplus", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "cancelAuctionedDebtWithSurplus", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "contractEnabled", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "debtAuctionHouse", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "disableTimestamp", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "extraSurplusReceiver", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "lastSurplusTime", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "postSettlementSurplusDrain", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "pushDebtToQueue", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "surplusAuctionHouse", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "totalOnAuctionDebt", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "totalQueuedDebt", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "transferExtraSurplus", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "transferPostSettlementSurplus", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "unqueuedUnauctionedDebt", data: BytesLike): Result;
    events: {
...
export type PopDebtFromQueueEventFilter = TypedEventFilter<PopDebtFromQueueEvent>;
...
export interface Iaccountingengine extends BaseContract {
    ...
    functions: {
        ...
        auctionDebt(overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        auctionSurplus(overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        cancelAuctionedDebtWithSurplus(_rad: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        popDebtFromQueue(_debtBlockTimestamp: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        postSettlementSurplusDrain(overrides?: CallOverrides): Promise<[string] & {
            _postSettlementSurplusDrain: string;
        }>;
        pushDebtToQueue(_debtBlock: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        surplusAuctionHouse(overrides?: CallOverrides): Promise<[string] & {
            _surplusAuctionHouse: string;
        }>;
        totalOnAuctionDebt(overrides?: CallOverrides): Promise<[BigNumber] & {
            _totalOnAuctionDebt: BigNumber;
        }>;
        totalQueuedDebt(overrides?: CallOverrides): Promise<[BigNumber] & {
            _totalQueuedDebt: BigNumber;
        }>;
        transferExtraSurplus(overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        transferPostSettlementSurplus(overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        unqueuedUnauctionedDebt(overrides?: CallOverrides): Promise<[BigNumber] & {
            _unqueuedUnauctionedDebt: BigNumber;
        }>;
    };
    _params(overrides?: CallOverrides): Promise<[
        BigNumber,
    ...
    params(overrides?: CallOverrides): Promise<IAccountingEngine.AccountingEngineParamsStructOutput>;
    popDebtFromQueue(_debtBlockTimestamp: BigNumberish, overrides?: Overrides & {
        from?: string;
    }): Promise<ContractTransaction>;
    postSettlementSurplusDrain(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        "authorizedAccounts(address)"(_account: string, overrides?: CallOverrides): Promise<boolean>;
        "authorizedAccounts()"(overrides?: CallOverrides): Promise<string[]>;
        cancelAuctionedDebtWithSurplus(_rad: BigNumberish, overrides?: CallOverrides): Promise<void>;
        contractEnabled(overrides?: CallOverrides): Promise<boolean>;
        debtAuctionHouse(overrides?: CallOverrides): Promise<string>;
        debtQueue(_blockTimestamp: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        params(overrides?: CallOverrides): Promise<IAccountingEngine.AccountingEngineParamsStructOutput>;
        popDebtFromQueue(_debtBlockTimestamp: BigNumberish, overrides?: CallOverrides): Promise<void>;
        postSettlementSurplusDrain(overrides?: CallOverrides): Promise<string>;
        pushDebtToQueue(_debtBlock: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "AuctionDebt(uint256,uint256,uint256)"(_id?: BigNumberish | null, _initialBid?: null, _debtAuctioned?: null): AuctionDebtEventFilter;
        AuctionDebt(_id?: BigNumberish | null, _initialBid?: null, _debtAuctioned?: null): AuctionDebtEventFilter;
        "AuctionSurplus(uint256,uint256,uint256)"(_id?: BigNumberish | null, _initialBid?: null, _surplusAuctioned?: null): AuctionSurplusEventFilter;
        AuctionSurplus(_id?: BigNumberish | null, _initialBid?: null, _surplusAuctioned?: null): AuctionSurplusEventFilter;
        "CancelDebt(uint256,uint256,uint256)"(_rad?: null, _coinBalance?: null, _debtBalance?: null): CancelDebtEventFilter;
        CancelDebt(_rad?: null, _coinBalance?: null, _debtBalance?: null): CancelDebtEventFilter;
        ...
        "PopDebtFromQueue(uint256,uint256)"(_timestamp?: BigNumberish | null, _debtAmount?: null): PopDebtFromQueueEventFilter;
        PopDebtFromQueue(_timestamp?: BigNumberish | null, _debtAmount?: null): PopDebtFromQueueEventFilter;
        "PushDebtToQueue(uint256,uint256)"(_timestamp?: BigNumberish | null, _debtAmount?: null): PushDebtToQueueEventFilter;
        PushDebtToQueue(_timestamp?: BigNumberish | null, _debtAmount?: null): PushDebtToQueueEventFilter;
        ...
        "SettleDebt(uint256,uint256,uint256)"(_rad?: null, _coinBalance?: null, _debtBalance?: null): SettleDebtEventFilter;
        SettleDebt(_rad?: null, _coinBalance?: null, _debtBalance?: null): SettleDebtEventFilter;
        "TransferSurplus(address,uint256)"(_extraSurplusReceiver?: string | null, _surplusTransferred?: null): TransferSurplusEventFilter;
        TransferSurplus(_extraSurplusReceiver?: string | null, _surplusTransferred?: null): TransferSurplusEventFilter;
    };
    estimateGas: {
    ...
    populateTransaction: {
        ...
        debtQueue(_blockTimestamp: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        disableContract(overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        ...
        postSettlementSurplusDrain(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        pushDebtToQueue(_debtBlock: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        removeAuthorization(_account: string, overrides?: Overrides & {
        ...
        surplusAuctionHouse(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        totalOnAuctionDebt(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        unqueuedUnauctionedDebt(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
