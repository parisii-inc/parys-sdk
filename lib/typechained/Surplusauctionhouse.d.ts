...
export interface SurplusauctionhouseInterface extends utils.Interface {
    functions: {
...
export interface Surplusauctionhouse extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SurplusauctionhouseInterface;
