...
export interface DenominatedoraclechildInterface extends utils.Interface {
    functions: {
...
export interface Denominatedoraclechild extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: DenominatedoraclechildInterface;
