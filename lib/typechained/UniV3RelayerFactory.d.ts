...
export interface UniV3RelayerFactoryInterface extends utils.Interface {
    functions: {
...
export interface UniV3RelayerFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: UniV3RelayerFactoryInterface;
