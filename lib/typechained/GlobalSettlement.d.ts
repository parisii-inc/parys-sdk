...
export declare namespace IGlobalSettlement {
    type GlobalSettlementParamsStruct = {
        shutdownCooldown: BigNumberish;
    };
    type GlobalSettlementParamsStructOutput = [BigNumber] & {
        shutdownCooldown: BigNumber;
    };
}
export interface GlobalSettlementInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "_params" | "accountingEngine" | "addAuthorization" | "authorizedAccounts(address)" | "authorizedAccounts()" | "calculateCashPrice" | "coinBag" | "coinJoin" | "coinsUsedToRedeem" | "collateralAuctionHouseFactory" | "collateralCashPrice" | "collateralJoinFactory" | "collateralShortfall" | "collateralTotalDebt" | "contractEnabled" | "disableContract" | "fastTrackAuction" | "finalCoinPerCollateralPrice" | "freeCollateral" | "freezeCollateralType" | "liquidationEngine" | "modifyParameters" | "oracleRelayer" | "outstandingCoinSupply" | "params" | "prepareCoinsForRedeeming" | "processSAFE" | "redeemCollateral" | "removeAuthorization" | "safeEngine" | "setOutstandingCoinSupply" | "shutdownSystem" | "shutdownTime" | "stabilityFeeTreasury"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "calculateCashPrice", values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "coinsUsedToRedeem", values: [BytesLike, string]): string;
    encodeFunctionData(functionFragment: "collateralAuctionHouseFactory", values?: undefined): string;
    encodeFunctionData(functionFragment: "collateralCashPrice", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "collateralJoinFactory", values?: undefined): string;
    encodeFunctionData(functionFragment: "collateralShortfall", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "collateralTotalDebt", values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "fastTrackAuction", values: [BytesLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "finalCoinPerCollateralPrice", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "freeCollateral", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "freezeCollateralType", values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "outstandingCoinSupply", values?: undefined): string;
    encodeFunctionData(functionFragment: "params", values?: undefined): string;
    encodeFunctionData(functionFragment: "prepareCoinsForRedeeming", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "processSAFE", values: [BytesLike, string]): string;
    encodeFunctionData(functionFragment: "redeemCollateral", values: [BytesLike, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "setOutstandingCoinSupply", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "calculateCashPrice", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "coinsUsedToRedeem", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "collateralAuctionHouseFactory", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "collateralCashPrice", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "collateralJoinFactory", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "collateralShortfall", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "collateralTotalDebt", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "fastTrackAuction", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "finalCoinPerCollateralPrice", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "freeCollateral", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "freezeCollateralType", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "outstandingCoinSupply", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "params", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "prepareCoinsForRedeeming", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "processSAFE", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setOutstandingCoinSupply", data: BytesLike): Result;
...
export type CalculateCashPriceEventFilter = TypedEventFilter<CalculateCashPriceEvent>;
...
export type FastTrackAuctionEventFilter = TypedEventFilter<FastTrackAuctionEvent>;
...
export type FreezeCollateralTypeEventFilter = TypedEventFilter<FreezeCollateralTypeEvent>;
...
export type PrepareCoinsForRedeemingEventFilter = TypedEventFilter<PrepareCoinsForRedeemingEvent>;
...
export type RedeemCollateralEventFilter = TypedEventFilter<RedeemCollateralEvent>;
...
export type SetOutstandingCoinSupplyEventFilter = TypedEventFilter<SetOutstandingCoinSupplyEvent>;
...
export interface GlobalSettlement extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: GlobalSettlementInterface;
    ...
    functions: {
        ...
        calculateCashPrice(_cType: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        coinBag(_usr: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            _wad: BigNumber;
        }>;
        coinJoin(overrides?: CallOverrides): Promise<[string]>;
        coinsUsedToRedeem(_cType: BytesLike, _usr: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            _wad: BigNumber;
        }>;
        collateralAuctionHouseFactory(overrides?: CallOverrides): Promise<[string]>;
        collateralCashPrice(_cType: BytesLike, overrides?: CallOverrides): Promise<[BigNumber] & {
            _ray: BigNumber;
        }>;
        collateralJoinFactory(overrides?: CallOverrides): Promise<[string]>;
        collateralShortfall(_cType: BytesLike, overrides?: CallOverrides): Promise<[BigNumber] & {
            _wad: BigNumber;
        }>;
        collateralTotalDebt(_cType: BytesLike, overrides?: CallOverrides): Promise<[BigNumber] & {
            _wad: BigNumber;
        }>;
        ...
        fastTrackAuction(_cType: BytesLike, _auctionId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        finalCoinPerCollateralPrice(_cType: BytesLike, overrides?: CallOverrides): Promise<[BigNumber] & {
            _ray: BigNumber;
        }>;
        freeCollateral(_cType: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        freezeCollateralType(_cType: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        prepareCoinsForRedeeming(_coinAmount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        processSAFE(_cType: BytesLike, _safe: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        redeemCollateral(_cType: BytesLike, _coinsAmount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        setOutstandingCoinSupply(overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    oracleRelayer(overrides?: CallOverrides): Promise<string>;
    outstandingCoinSupply(overrides?: CallOverrides): Promise<BigNumber>;
    params(overrides?: CallOverrides): Promise<IGlobalSettlement.GlobalSettlementParamsStructOutput>;
    prepareCoinsForRedeeming(_coinAmount: BigNumberish, overrides?: Overrides & {
        from?: string;
    }): Promise<ContractTransaction>;
    processSAFE(_cType: BytesLike, _safe: string, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        "authorizedAccounts(address)"(_account: string, overrides?: CallOverrides): Promise<boolean>;
        "authorizedAccounts()"(overrides?: CallOverrides): Promise<string[]>;
        calculateCashPrice(_cType: BytesLike, overrides?: CallOverrides): Promise<void>;
        coinBag(_usr: string, overrides?: CallOverrides): Promise<BigNumber>;
        coinJoin(overrides?: CallOverrides): Promise<string>;
        coinsUsedToRedeem(_cType: BytesLike, _usr: string, overrides?: CallOverrides): Promise<BigNumber>;
        collateralAuctionHouseFactory(overrides?: CallOverrides): Promise<string>;
        ...
        fastTrackAuction(_cType: BytesLike, _auctionId: BigNumberish, overrides?: CallOverrides): Promise<void>;
        finalCoinPerCollateralPrice(_cType: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        freeCollateral(_cType: BytesLike, overrides?: CallOverrides): Promise<void>;
        freezeCollateralType(_cType: BytesLike, overrides?: CallOverrides): Promise<void>;
        liquidationEngine(overrides?: CallOverrides): Promise<string>;
        modifyParameters(_param: BytesLike, _data: BytesLike, overrides?: CallOverrides): Promise<void>;
        oracleRelayer(overrides?: CallOverrides): Promise<string>;
        outstandingCoinSupply(overrides?: CallOverrides): Promise<BigNumber>;
        params(overrides?: CallOverrides): Promise<IGlobalSettlement.GlobalSettlementParamsStructOutput>;
        prepareCoinsForRedeeming(_coinAmount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        processSAFE(_cType: BytesLike, _safe: string, overrides?: CallOverrides): Promise<void>;
        redeemCollateral(_cType: BytesLike, _coinsAmount: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "CalculateCashPrice(bytes32,uint256)"(_cType?: BytesLike | null, _collateralCashPrice?: null): CalculateCashPriceEventFilter;
        CalculateCashPrice(_cType?: BytesLike | null, _collateralCashPrice?: null): CalculateCashPriceEventFilter;
        "DisableContract()"(): DisableContractEventFilter;
        DisableContract(): DisableContractEventFilter;
        "FastTrackAuction(bytes32,uint256,uint256)"(_cType?: BytesLike | null, _auctionId?: BigNumberish | null, _collateralTotalDebt?: null): FastTrackAuctionEventFilter;
        FastTrackAuction(_cType?: BytesLike | null, _auctionId?: BigNumberish | null, _collateralTotalDebt?: null): FastTrackAuctionEventFilter;
        "FreeCollateral(bytes32,address,uint256)"(_cType?: BytesLike | null, _sender?: string | null, _collateralAmount?: null): FreeCollateralEventFilter;
        FreeCollateral(_cType?: BytesLike | null, _sender?: string | null, _collateralAmount?: null): FreeCollateralEventFilter;
        "FreezeCollateralType(bytes32,uint256)"(_cType?: BytesLike | null, _finalCoinPerCollateralPrice?: null): FreezeCollateralTypeEventFilter;
        FreezeCollateralType(_cType?: BytesLike | null, _finalCoinPerCollateralPrice?: null): FreezeCollateralTypeEventFilter;
        ...
        "PrepareCoinsForRedeeming(address,uint256)"(_sender?: string | null, _coinBag?: null): PrepareCoinsForRedeemingEventFilter;
        PrepareCoinsForRedeeming(_sender?: string | null, _coinBag?: null): PrepareCoinsForRedeemingEventFilter;
        "ProcessSAFE(bytes32,address,uint256)"(_cType?: BytesLike | null, _safe?: string | null, _collateralShortfall?: null): ProcessSAFEEventFilter;
        ProcessSAFE(_cType?: BytesLike | null, _safe?: string | null, _collateralShortfall?: null): ProcessSAFEEventFilter;
        "RedeemCollateral(bytes32,address,uint256,uint256)"(_cType?: BytesLike | null, _sender?: string | null, _coinsAmount?: null, _collateralAmount?: null): RedeemCollateralEventFilter;
        RedeemCollateral(_cType?: BytesLike | null, _sender?: string | null, _coinsAmount?: null, _collateralAmount?: null): RedeemCollateralEventFilter;
        ...
        "SetOutstandingCoinSupply(uint256)"(_outstandingCoinSupply?: null): SetOutstandingCoinSupplyEventFilter;
        SetOutstandingCoinSupply(_outstandingCoinSupply?: null): SetOutstandingCoinSupplyEventFilter;
    ...
    estimateGas: {
        ...
        coinsUsedToRedeem(_cType: BytesLike, _usr: string, overrides?: CallOverrides): Promise<BigNumber>;
        collateralAuctionHouseFactory(overrides?: CallOverrides): Promise<BigNumber>;
        collateralCashPrice(_cType: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        coinBag(_usr: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        coinJoin(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        coinsUsedToRedeem(_cType: BytesLike, _usr: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        collateralAuctionHouseFactory(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        collateralCashPrice(_cType: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        collateralJoinFactory(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        collateralShortfall(_cType: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        collateralTotalDebt(_cType: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        finalCoinPerCollateralPrice(_cType: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        freeCollateral(_cType: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        freezeCollateralType(_cType: BytesLike, overrides?: Overrides & {
        ...
        outstandingCoinSupply(overrides?: CallOverrides): Promise<PopulatedTransaction>;
