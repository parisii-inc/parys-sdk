...
export interface ICollateralJoinInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addAuthorization" | "authorizedAccounts(address)" | "authorizedAccounts()" | "collateral" | "collateralType" | "contractEnabled" | "decimals" | "disableContract" | "exit" | "join" | "multiplier" | "removeAuthorization" | "safeEngine"): FunctionFragment;
...
export interface ICollateralJoin extends BaseContract {
