...
export interface ModifiablepercollateralInterface extends utils.Interface {
    functions: {
...
export interface Modifiablepercollateral extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ModifiablepercollateralInterface;
