...
export interface IAbstractVeloVaultRelayerInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "getResultWithValidity" | "read" | "symbol" | "veloLpOracle" | "veloPool"): FunctionFragment;
...
export interface IAbstractVeloVaultRelayer extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IAbstractVeloVaultRelayerInterface;
