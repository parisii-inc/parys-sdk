...
export declare namespace ITokenDistributor {
    type TokenDistributorParamsStruct = {
        root: BytesLike;
        totalClaimable: BigNumberish;
        claimPeriodStart: BigNumberish;
        claimPeriodEnd: BigNumberish;
    };
    type TokenDistributorParamsStructOutput = [
        string,
        BigNumber,
        BigNumber,
        BigNumber
        ...
        claimPeriodStart: BigNumber;
        claimPeriodEnd: BigNumber;
    };
}
