...
export interface DisableableChildInterface extends utils.Interface {
    functions: {
...
export interface DisableableChild extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: DisableableChildInterface;
