...
export interface IsettlementsurplusauctioneerInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "accountingEngine" | "addAuthorization" | "auctionSurplus" | "authorizedAccounts(address)" | "authorizedAccounts()" | "lastSurplusTime" | "modifyParameters" | "removeAuthorization" | "safeEngine" | "surplusAuctionHouse"): FunctionFragment;
...
export interface Isettlementsurplusauctioneer extends BaseContract {
    ...
    filters: {
        ...
        "AuctionSurplus(uint256,uint256,uint256)"(_id?: BigNumberish | null, _lastSurplusAuctionTime?: null, _coinBalance?: null): AuctionSurplusEventFilter;
        AuctionSurplus(_id?: BigNumberish | null, _lastSurplusAuctionTime?: null, _coinBalance?: null): AuctionSurplusEventFilter;
