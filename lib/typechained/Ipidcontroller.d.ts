...
export interface IpidcontrollerInterface extends utils.Interface {
    functions: {
...
export interface Ipidcontroller extends BaseContract {
    ...
    functions: {
        ...
        _params(overrides?: CallOverrides): Promise<[
            ...
            _integralPeriodSize: BigNumber;
            _perSecondCumulativeLeak: BigNumber;
            _noiseBarrier: BigNumber;
            _feedbackOutputUpperBound: BigNumber;
            _feedbackOutputLowerBound: BigNumber;
        }>;
        ...
        breaksNoiseBarrier(_piSum: BigNumberish, _targetPrice: BigNumberish, overrides?: CallOverrides): Promise<[boolean] & {
            _breaksNb: boolean;
        }>;
        ...
        getGainAdjustedTerms(_proportionalTerm: BigNumberish, _integralTerm: BigNumberish, overrides?: CallOverrides): Promise<[
            ...
            _proportionalGain: BigNumber;
            _integralGain: BigNumber;
        }>;
        getNextDeviationCumulative(_proportionalTerm: BigNumberish, _accumulatedLeak: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        getNextRedemptionRate(_marketPrice: BigNumberish, _targetPrice: BigNumberish, _accumulatedLeak: BigNumberish, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber
        ] & {
    ...
    callStatic: {
        ...
        getNextDeviationCumulative(_proportionalTerm: BigNumberish, _accumulatedLeak: BigNumberish, overrides?: CallOverrides): Promise<[
            ...
            _priceDeviationCumulative: BigNumber;
            _timeAdjustedDeviation: BigNumber;
        }>;
        getNextRedemptionRate(_marketPrice: BigNumberish, _targetPrice: BigNumberish, _accumulatedLeak: BigNumberish, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
    ...
    estimateGas: {
        ...
        breaksNoiseBarrier(_piSum: BigNumberish, _targetPrice: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        computeRate(_marketPrice: BigNumberish, _targetPrice: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        ...
        getNextRedemptionRate(_marketPrice: BigNumberish, _targetPrice: BigNumberish, _accumulatedLeak: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        modifyParameters(_param: BytesLike, _data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        breaksNoiseBarrier(_piSum: BigNumberish, _targetPrice: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        computeRate(_marketPrice: BigNumberish, _targetPrice: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        ...
        getNextRedemptionRate(_marketPrice: BigNumberish, _targetPrice: BigNumberish, _accumulatedLeak: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        modifyParameters(_param: BytesLike, _data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
