...
export interface IstakingmanagerInterface extends utils.Interface {
    functions: {
...
export interface Istakingmanager extends BaseContract {
    ...
    functions: {
        ...
        params(overrides?: CallOverrides): Promise<[
            ...
            _params: IStakingManager.StakingManagerParamsStructOutput;
        }>;
        ...
        stakedBalances(_account: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            _stakedBalance: BigNumber;
        }>;
        stakedSupply(overrides?: CallOverrides): Promise<[BigNumber] & {
            _stakedSupply: BigNumber;
        }>;
    ...
    populateTransaction: {
        ...
        stakedBalances(_account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
