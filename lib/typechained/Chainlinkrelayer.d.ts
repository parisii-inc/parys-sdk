...
export interface ChainlinkrelayerInterface extends utils.Interface {
    functions: {
...
export interface Chainlinkrelayer extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ChainlinkrelayerInterface;
