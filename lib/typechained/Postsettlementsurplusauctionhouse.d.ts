...
export interface PostsettlementsurplusauctionhouseInterface extends utils.Interface {
    functions: {
...
export interface Postsettlementsurplusauctionhouse extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: PostsettlementsurplusauctionhouseInterface;
    ...
    functions: {
        ...
        _auctions(arg0: BigNumberish, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            string,
            BigNumber,
    ...
    estimateGas: {
        ...
        _auctions(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        _auctions(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
