...
export interface IgovernorInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "CLOCK_MODE" | "COUNTING_MODE" | "cancel" | "castVote" | "castVoteBySig" | "castVoteWithReason" | "castVoteWithReasonAndParams" | "castVoteWithReasonAndParamsBySig" | "clock" | "execute" | "getVotes" | "getVotesWithParams" | "hasVoted" | "hashProposal" | "name" | "proposalDeadline" | "proposalEta" | "proposalNeedsQueuing" | "proposalProposer" | "proposalSnapshot" | "proposalThreshold" | "propose" | "queue" | "quorum" | "state" | "supportsInterface" | "version" | "votingDelay" | "votingPeriod"): FunctionFragment;
