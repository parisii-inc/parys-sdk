...
export interface AuthorizableChildInterface extends utils.Interface {
    functions: {
...
export interface AuthorizableChild extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AuthorizableChildInterface;
