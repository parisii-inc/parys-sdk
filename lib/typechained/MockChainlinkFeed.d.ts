...
export interface MockChainlinkFeedInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "decimals" | "description" | "getRoundData" | "latestRoundData" | "setPrice" | "version"): FunctionFragment;
