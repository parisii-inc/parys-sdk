...
export interface CollateraljoinchildInterface extends utils.Interface {
    functions: {
...
export interface Collateraljoinchild extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CollateraljoinchildInterface;
