...
export interface Iglobalsettlement extends BaseContract {
    ...
    functions: {
        ...
        coinsUsedToRedeem(_cType: BytesLike, _coinHolder: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            _coinsUsedToRedeem: BigNumber;
        }>;
        collateralAuctionHouseFactory(overrides?: CallOverrides): Promise<[string] & {
            _collateralAuctionHouseFactory: string;
        }>;
    ...
    populateTransaction: {
        ...
        coinBag(_coinHolder: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        coinJoin(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        coinsUsedToRedeem(_cType: BytesLike, _coinHolder: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
