...
export interface SystemcointaxcollectorInterface extends utils.Interface {
    functions: {
    ...
    events: {
        ...
        "ProxyFactorySet(address)": EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "ProxyFactorySet"): EventFragment;
...
export interface ProxyFactorySetEventObject {
    proxyFactory: string;
}
export type ProxyFactorySetEvent = TypedEvent<[
    string
], ProxyFactorySetEventObject>;
export type ProxyFactorySetEventFilter = TypedEventFilter<ProxyFactorySetEvent>;
...
export interface Systemcointaxcollector extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SystemcointaxcollectorInterface;
    ...
    functions: {
        ...
        customTaxRates(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
        defaultTaxRateBasisPoints(overrides?: CallOverrides): Promise<[BigNumber]>;
        exemptAddresses(arg0: string, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    filters: {
        ...
        "ProxyFactorySet(address)"(proxyFactory?: string | null): ProxyFactorySetEventFilter;
        ProxyFactorySet(proxyFactory?: string | null): ProxyFactorySetEventFilter;
    ...
    estimateGas: {
        ...
        customTaxRates(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
        defaultTaxRateBasisPoints(overrides?: CallOverrides): Promise<BigNumber>;
        exemptAddresses(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
        getTaxRate(_account: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        customTaxRates(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        defaultTaxRateBasisPoints(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        exemptAddresses(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
