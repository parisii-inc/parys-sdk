...
export interface IcommonactionsInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "exitAllSystemCoins" | "exitCollateral" | "exitSystemCoins" | "joinSystemCoins"): FunctionFragment;
