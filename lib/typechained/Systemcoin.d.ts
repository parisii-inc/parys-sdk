...
export interface SystemcoinInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "DOMAIN_SEPARATOR" | "addAuthorization" | "allowance" | "approve" | "authorizedAccounts(address)" | "authorizedAccounts()" | "balanceOf" | "burn" | "decimals" | "eip712Domain" | "mint" | "name" | "nonces" | "permit" | "removeAuthorization" | "symbol" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
...
export interface Systemcoin extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SystemcoinInterface;
