...
export interface ITaxCollector extends BaseContract {
    ...
    functions: {
        ...
        _secondaryTaxReceivers(_cType: BytesLike, _receiver: string, overrides?: CallOverrides): Promise<[
            string,
            boolean,
            BigNumber
        ] & {
    ...
    estimateGas: {
        ...
        _secondaryTaxReceivers(_cType: BytesLike, _receiver: string, overrides?: CallOverrides): Promise<BigNumber>;
        addAuthorization(_account: string, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        _secondaryTaxReceivers(_cType: BytesLike, _receiver: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        addAuthorization(_account: string, overrides?: Overrides & {
            from?: string;
