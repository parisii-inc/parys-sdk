...
export interface IdebtauctionhouseInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "AUCTION_HOUSE_TYPE" | "_auctions" | "_params" | "accountingEngine" | "activeDebtAuctions" | "addAuthorization" | "auctions" | "auctionsStarted" | "authorizedAccounts(address)" | "authorizedAccounts()" | "contractEnabled" | "decreaseSoldAmount" | "disableContract" | "modifyParameters" | "params" | "protocolToken" | "removeAuthorization" | "restartAuction" | "safeEngine" | "settleAuction" | "startAuction" | "terminateAuctionPrematurely"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "activeDebtAuctions", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "decreaseSoldAmount", values: [BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "startAuction", values: [string, BigNumberish, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "activeDebtAuctions", data: BytesLike): Result;
...
export type DecreaseSoldAmountEventFilter = TypedEventFilter<DecreaseSoldAmountEvent>;
...
export interface Idebtauctionhouse extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IdebtauctionhouseInterface;
    ...
    functions: {
        ...
        _params(overrides?: CallOverrides): Promise<[
            ...
            _bidDecrease: BigNumber;
            _amountSoldIncrease: BigNumber;
        ...
        decreaseSoldAmount(_id: BigNumberish, _amountToBuy: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        startAuction(_incomeReceiver: string, _amountToSell: BigNumberish, _initialBid: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    auctions(_id: BigNumberish, overrides?: CallOverrides): Promise<IDebtAuctionHouse.AuctionStructOutput>;
    auctionsStarted(overrides?: CallOverrides): Promise<BigNumber>;
    "authorizedAccounts(address)"(_account: string, overrides?: CallOverrides): Promise<boolean>;
    "authorizedAccounts()"(overrides?: CallOverrides): Promise<string[]>;
    contractEnabled(overrides?: CallOverrides): Promise<boolean>;
    ...
    params(overrides?: CallOverrides): Promise<IDebtAuctionHouse.DebtAuctionHouseParamsStructOutput>;
    protocolToken(overrides?: CallOverrides): Promise<string>;
    removeAuthorization(_account: string, overrides?: Overrides & {
        from?: string;
    }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "authorizedAccounts()"(overrides?: CallOverrides): Promise<string[]>;
        contractEnabled(overrides?: CallOverrides): Promise<boolean>;
        decreaseSoldAmount(_id: BigNumberish, _amountToBuy: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        startAuction(_incomeReceiver: string, _amountToSell: BigNumberish, _initialBid: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    filters: {
        ...
        "DecreaseSoldAmount(uint256,address,uint256,uint256,uint256,uint256)"(_id?: BigNumberish | null, _bidder?: null, _blockTimestamp?: null, _raisedAmount?: null, _soldAmount?: null, _bidExpiry?: null): DecreaseSoldAmountEventFilter;
        DecreaseSoldAmount(_id?: BigNumberish | null, _bidder?: null, _blockTimestamp?: null, _raisedAmount?: null, _soldAmount?: null, _bidExpiry?: null): DecreaseSoldAmountEventFilter;
    ...
    populateTransaction: {
        ...
        activeDebtAuctions(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        addAuthorization(_account: string, overrides?: Overrides & {
            from?: string;
