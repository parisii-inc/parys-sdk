...
export interface LiquidationEngineInterface extends utils.Interface {
    functions: {
        ...
        "attemptSave(bytes32,address,address,(uint256,uint256))": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "attemptSave", values: [BytesLike, string, string, ISAFEEngine.SAFEStruct]): string;
    ...
    decodeFunctionResult(functionFragment: "attemptSave", data: BytesLike): Result;
...
export interface LiquidationEngine extends BaseContract {
    ...
    functions: {
        ...
        attemptSave(_cType: BytesLike, _safe: string, _liquidator: string, _safeData: ISAFEEngine.SAFEStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        getLimitAdjustedDebtToCover(_cType: BytesLike, _safe: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            _limitAdjustedDebtToCover: BigNumber;
        }>;
    ...
    callStatic: {
        ...
        attemptSave(_cType: BytesLike, _safe: string, _liquidator: string, _safeData: ISAFEEngine.SAFEStruct, overrides?: CallOverrides): Promise<ISAFEEngine.SAFEStructOutput>;
        "authorizedAccounts(address)"(_account: string, overrides?: CallOverrides): Promise<boolean>;
        "authorizedAccounts()"(overrides?: CallOverrides): Promise<string[]>;
        cParams(_cType: BytesLike, overrides?: CallOverrides): Promise<ILiquidationEngine.LiquidationEngineCollateralParamsStructOutput>;
        chosenSAFESaviour(_cType: BytesLike, _safe: string, overrides?: CallOverrides): Promise<string>;
