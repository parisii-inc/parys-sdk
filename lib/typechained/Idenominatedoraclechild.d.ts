...
export interface IdenominatedoraclechildInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "denominationPriceSource" | "factory" | "getResultWithValidity" | "inverted" | "priceSource" | "read" | "symbol"): FunctionFragment;
...
export interface Idenominatedoraclechild extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IdenominatedoraclechildInterface;
