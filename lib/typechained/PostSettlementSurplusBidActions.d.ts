...
export interface PostSettlementSurplusBidActionsInterface extends utils.Interface {
    functions: {
...
export interface PostSettlementSurplusBidActions extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: PostSettlementSurplusBidActionsInterface;
