...
export interface CollateralauctionhouseInterface extends utils.Interface {
    functions: {
...
export interface Collateralauctionhouse extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CollateralauctionhouseInterface;
