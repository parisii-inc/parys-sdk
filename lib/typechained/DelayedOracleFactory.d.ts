...
export interface DelayedOracleFactoryInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addAuthorization" | "authorizedAccounts(address)" | "authorizedAccounts()" | "delayedOraclesList" | "deployDelayedOracle" | "removeAuthorization"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "delayedOraclesList", values?: undefined): string;
    encodeFunctionData(functionFragment: "deployDelayedOracle", values: [string, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "delayedOraclesList", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "deployDelayedOracle", data: BytesLike): Result;
...
export type NewDelayedOracleEventFilter = TypedEventFilter<NewDelayedOracleEvent>;
...
export interface DelayedOracleFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: DelayedOracleFactoryInterface;
    ...
    functions: {
        ...
        delayedOraclesList(overrides?: CallOverrides): Promise<[string[]] & {
            _delayedOraclesList: string[];
        }>;
        deployDelayedOracle(_priceSource: string, _updateDelay: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "authorizedAccounts()"(overrides?: CallOverrides): Promise<string[]>;
        delayedOraclesList(overrides?: CallOverrides): Promise<string[]>;
        deployDelayedOracle(_priceSource: string, _updateDelay: BigNumberish, overrides?: CallOverrides): Promise<string>;
    ...
    filters: {
        ...
        "NewDelayedOracle(address,address,uint256)"(_delayedOracle?: string | null, _priceSource?: null, _updateDelay?: null): NewDelayedOracleEventFilter;
        NewDelayedOracle(_delayedOracle?: string | null, _priceSource?: null, _updateDelay?: null): NewDelayedOracleEventFilter;
    ...
    populateTransaction: {
        ...
        delayedOraclesList(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        deployDelayedOracle(_priceSource: string, _updateDelay: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        removeAuthorization(_account: string, overrides?: Overrides & {
