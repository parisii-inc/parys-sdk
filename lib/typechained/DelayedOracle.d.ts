...
export interface DelayedOracleInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "getNextResultWithValidity" | "getResultWithValidity" | "lastUpdateTime" | "priceSource" | "read" | "shouldUpdate" | "symbol" | "updateDelay" | "updateResult"): FunctionFragment;
...
export interface DelayedOracle extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: DelayedOracleInterface;
    ...
    getNextResultWithValidity(overrides?: CallOverrides): Promise<[BigNumber, boolean] & {
        _result: BigNumber;
        _validity: boolean;
    }>;
