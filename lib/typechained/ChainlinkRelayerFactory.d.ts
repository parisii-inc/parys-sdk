...
export interface ChainlinkRelayerFactoryInterface extends utils.Interface {
    functions: {
...
export interface ChainlinkRelayerFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ChainlinkRelayerFactoryInterface;
