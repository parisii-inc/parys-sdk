...
export interface Univ3relayerchildInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "baseAmount" | "baseToken" | "factory" | "getResultWithValidity" | "multiplier" | "quotePeriod" | "quoteToken" | "read" | "symbol" | "uniV3Pool"): FunctionFragment;
...
export interface Univ3relayerchild extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: Univ3relayerchildInterface;
