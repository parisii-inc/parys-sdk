...
export interface CollateralauctionhousefactoryInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "_cParams" | "addAuthorization" | "authorizedAccounts(address)" | "authorizedAccounts()" | "cParams" | "collateralAuctionHouses" | "collateralAuctionHousesList" | "collateralList" | "contractEnabled" | "disableContract" | "initializeCollateralType" | "liquidationEngine" | "modifyParameters(bytes32,bytes32,bytes)" | "modifyParameters(bytes32,bytes)" | "oracleRelayer" | "removeAuthorization" | "safeEngine"): FunctionFragment;
...
export interface Collateralauctionhousefactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CollateralauctionhousefactoryInterface;
    ...
    functions: {
        ...
        collateralAuctionHousesList(overrides?: CallOverrides): Promise<[string[]] & {
            _collateralAuctionHousesList: string[];
        }>;
