...
export interface IOracleRelayerInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "_cParams" | "_params" | "addAuthorization" | "authorizedAccounts(address)" | "authorizedAccounts()" | "cParams" | "calcRedemptionPrice" | "carbonPriceIndexOracle" | "collateralList" | "contractEnabled" | "disableContract" | "initializeCollateralType" | "marketPrice" | "modifyParameters(bytes32,bytes32,bytes)" | "modifyParameters(bytes32,bytes)" | "params" | "redemptionPrice" | "redemptionPriceUpdateTime" | "redemptionRate" | "removeAuthorization" | "safeEngine" | "systemCoinOracle" | "targetRedemptionPrice" | "updateCollateralPrice" | "updateRedemptionPriceFromOracle" | "updateRedemptionRate"): FunctionFragment;
...
export interface IOracleRelayer extends BaseContract {
    ...
    functions: {
        _cParams(_cType: BytesLike, overrides?: CallOverrides): Promise<[
            ...
            _oracle: string;
            _safetyCRatio: BigNumber;
            _liquidationCRatio: BigNumber;
        }>;
        _params(overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber
        ] & {
            _redemptionRateUpperBound: BigNumber;
            _redemptionRateLowerBound: BigNumber;
        }>;
        ...
        carbonPriceIndexOracle(overrides?: CallOverrides): Promise<[string] & {
            _carbonPriceIndexOracle: string;
        }>;
        ...
        redemptionPriceUpdateTime(overrides?: CallOverrides): Promise<[BigNumber] & {
            _redemptionPriceUpdateTime: BigNumber;
        }>;
