...
export interface HardcodedOracleInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "getResultWithValidity" | "price" | "read" | "symbol"): FunctionFragment;
...
export interface HardcodedOracle extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HardcodedOracleInterface;
