...
export interface IbeefyvelovaultrelayerInterface extends utils.Interface {
    functions: {
...
export interface Ibeefyvelovaultrelayer extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IbeefyvelovaultrelayerInterface;
