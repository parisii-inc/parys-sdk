...
export interface ICollateralJoinChildInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addAuthorization" | "authorizedAccounts(address)" | "authorizedAccounts()" | "collateral" | "collateralType" | "contractEnabled" | "decimals" | "disableContract" | "exit" | "factory" | "join" | "multiplier" | "removeAuthorization" | "safeEngine"): FunctionFragment;
...
export interface ICollateralJoinChild extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ICollateralJoinChildInterface;
