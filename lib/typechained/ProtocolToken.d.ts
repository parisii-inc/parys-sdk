...
export interface ProtocolTokenInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "CLOCK_MODE" | "DOMAIN_SEPARATOR" | "addAuthorization" | "allowance" | "approve" | "authorizedAccounts(address)" | "authorizedAccounts()" | "balanceOf" | "burn" | "checkpoints" | "clock" | "decimals" | "delegate" | "delegateBySig" | "delegates" | "eip712Domain" | "getPastTotalSupply" | "getPastVotes" | "getVotes" | "mint" | "name" | "nonces" | "numCheckpoints" | "paused" | "permit" | "removeAuthorization" | "symbol" | "totalSupply" | "transfer" | "transferFrom" | "unpause"): FunctionFragment;
