...
export interface WrappedtokenInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "BASE_TOKEN" | "DOMAIN_SEPARATOR" | "addAuthorization" | "allowance" | "approve" | "authorizedAccounts(address)" | "authorizedAccounts()" | "balanceOf" | "baseTokenManager" | "decimals" | "deposit" | "eip712Domain" | "modifyParameters" | "name" | "nonces" | "permit" | "removeAuthorization" | "symbol" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
