...
export interface ContractscoreInterface extends utils.Interface {
    functions: {
...
export interface Contractscore extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ContractscoreInterface;
