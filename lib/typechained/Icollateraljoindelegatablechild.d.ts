...
export interface IcollateraljoindelegatablechildInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addAuthorization" | "authorizedAccounts(address)" | "authorizedAccounts()" | "collateral" | "collateralType" | "contractEnabled" | "decimals" | "delegatee" | "disableContract" | "exit" | "factory" | "join" | "multiplier" | "removeAuthorization" | "safeEngine"): FunctionFragment;
...
export interface Icollateraljoindelegatablechild extends BaseContract {
    ...
    functions: {
        ...
        exit(_account: string, _wei: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        factory(overrides?: CallOverrides): Promise<[string] & {
            _factory: string;
        }>;
        join(_account: string, _wei: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        exit(_account: string, _wei: BigNumberish, overrides?: CallOverrides): Promise<void>;
        factory(overrides?: CallOverrides): Promise<string>;
        join(_account: string, _wei: BigNumberish, overrides?: CallOverrides): Promise<void>;
        multiplier(overrides?: CallOverrides): Promise<BigNumber>;
