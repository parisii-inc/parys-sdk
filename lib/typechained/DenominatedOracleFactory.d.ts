...
export interface DenominatedOracleFactoryInterface extends utils.Interface {
    functions: {
...
export interface DenominatedOracleFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: DenominatedOracleFactoryInterface;
