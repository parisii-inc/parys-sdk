...
export interface IBeefyVeloVaultRelayerFactoryInterface extends utils.Interface {
    functions: {
...
export interface IBeefyVeloVaultRelayerFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IBeefyVeloVaultRelayerFactoryInterface;
