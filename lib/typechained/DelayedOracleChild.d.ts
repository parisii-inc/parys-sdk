...
export interface DelayedOracleChildInterface extends utils.Interface {
    functions: {
...
export interface DelayedOracleChild extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: DelayedOracleChildInterface;
