...
export interface IStakingTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "addAuthorization"
...
export namespace StakingTokenBurnEvent {
  export type InputTuple = [_src: AddressLike, _wad: BigNumberish];
  export type OutputTuple = [_src: string, _wad: bigint];
  export interface OutputObject {
    _src: string;
    _wad: bigint;
  }
...
export namespace StakingTokenMintEvent {
  export type InputTuple = [_dst: AddressLike, _wad: BigNumberish];
  export type OutputTuple = [_dst: string, _wad: bigint];
  export interface OutputObject {
    _dst: string;
    _wad: bigint;
  }
...
export interface IStakingToken extends BaseContract {
  connect(runner?: ContractRunner | null): IStakingToken;
  ...
  burn: TypedContractMethod<[_wad: BigNumberish], [void], "nonpayable">;
  ...
  mint: TypedContractMethod<
    [_dst: AddressLike, _wad: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getEvent(
    key: "StakingTokenBurn"
  ): TypedContractEvent<
    StakingTokenBurnEvent.InputTuple,
    StakingTokenBurnEvent.OutputTuple,
    StakingTokenBurnEvent.OutputObject
  >;
  getEvent(
    key: "StakingTokenMint"
  ): TypedContractEvent<
    StakingTokenMintEvent.InputTuple,
    StakingTokenMintEvent.OutputTuple,
    StakingTokenMintEvent.OutputObject
  >;
  getEvent(
    key: "Transfer"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "StakingTokenBurn(address,uint256)": TypedContractEvent<
      StakingTokenBurnEvent.InputTuple,
      StakingTokenBurnEvent.OutputTuple,
      StakingTokenBurnEvent.OutputObject
    >;
    StakingTokenBurn: TypedContractEvent<
      StakingTokenBurnEvent.InputTuple,
      StakingTokenBurnEvent.OutputTuple,
      StakingTokenBurnEvent.OutputObject
    >;

    "StakingTokenMint(address,uint256)": TypedContractEvent<
      StakingTokenMintEvent.InputTuple,
      StakingTokenMintEvent.OutputTuple,
      StakingTokenMintEvent.OutputObject
    >;
    StakingTokenMint: TypedContractEvent<
      StakingTokenMintEvent.InputTuple,
      StakingTokenMintEvent.OutputTuple,
      StakingTokenMintEvent.OutputObject
    >;
