...
import type {
  ...
  IPostSettlementSurplusAuctionHouseInterface,
} from "../IPostSettlementSurplusAuctionHouse";
    ...
    outputs: [
      {
        ...
        type: "tuple",
        internalType:
          "struct IPostSettlementSurplusAuctionHouse.PostSettlementSAHParams",
        components: [
          {
            name: "bidIncrease",
            type: "uint256",
...
export class IPostSettlementSurplusAuctionHouse__factory {
  static readonly abi = _abi;
  static createInterface(): IPostSettlementSurplusAuctionHouseInterface {
    return new Interface(_abi) as IPostSettlementSurplusAuctionHouseInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IPostSettlementSurplusAuctionHouse;
  }
}
