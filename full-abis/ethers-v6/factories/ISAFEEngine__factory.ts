...
export class ISAFEEngine__factory {
  ...
  static createInterface(): ISAFEEngineInterface {
    return new Interface(_abi) as ISAFEEngineInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): ISAFEEngine {
    return new Contract(address, _abi, runner) as unknown as ISAFEEngine;
  }
}
