...
export class IOracleJob__factory {
  ...
  static createInterface(): IOracleJobInterface {
    return new Interface(_abi) as IOracleJobInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IOracleJob {
    return new Contract(address, _abi, runner) as unknown as IOracleJob;
  }
}
