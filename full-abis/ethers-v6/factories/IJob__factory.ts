...
export class IJob__factory {
  ...
  static createInterface(): IJobInterface {
    return new Interface(_abi) as IJobInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IJob {
    return new Contract(address, _abi, runner) as unknown as IJob;
  }
}
