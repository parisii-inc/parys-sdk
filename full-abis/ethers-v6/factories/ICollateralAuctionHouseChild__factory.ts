...
import type {
  ...
  ICollateralAuctionHouseChildInterface,
} from "../ICollateralAuctionHouseChild";
    ...
    outputs: [
      {
        ...
        type: "tuple",
        internalType:
          "struct ICollateralAuctionHouse.CollateralAuctionHouseParams",
        components: [
          {
            name: "minimumBid",
            type: "uint256",
...
export class ICollateralAuctionHouseChild__factory {
  static readonly abi = _abi;
  static createInterface(): ICollateralAuctionHouseChildInterface {
    return new Interface(_abi) as ICollateralAuctionHouseChildInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ICollateralAuctionHouseChild;
  }
}
