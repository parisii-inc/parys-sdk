...
export class ICoinJoin__factory {
  ...
  static createInterface(): ICoinJoinInterface {
    return new Interface(_abi) as ICoinJoinInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): ICoinJoin {
    return new Contract(address, _abi, runner) as unknown as ICoinJoin;
  }
}
