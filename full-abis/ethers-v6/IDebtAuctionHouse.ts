...
export interface IDebtAuctionHouseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "AUCTION_HOUSE_TYPE"
      | "_auctions"
...
export namespace DecreaseSoldAmountEvent {
...
export interface IDebtAuctionHouse extends BaseContract {
  connect(runner?: ContractRunner | null): IDebtAuctionHouse;
  ...
  activeDebtAuctions: TypedContractMethod<[], [bigint], "view">;
  ...
  decreaseSoldAmount: TypedContractMethod<
    [_id: BigNumberish, _amountToBuy: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "activeDebtAuctions"
  ...
  >;
  getEvent(
    key: "DecreaseSoldAmount"
  ): TypedContractEvent<
    DecreaseSoldAmountEvent.InputTuple,
    DecreaseSoldAmountEvent.OutputTuple,
    DecreaseSoldAmountEvent.OutputObject
  >;
  getEvent(
    key: "DisableContract"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "DecreaseSoldAmount(uint256,address,uint256,uint256,uint256,uint256)": TypedContractEvent<
      DecreaseSoldAmountEvent.InputTuple,
      DecreaseSoldAmountEvent.OutputTuple,
      DecreaseSoldAmountEvent.OutputObject
    >;
    DecreaseSoldAmount: TypedContractEvent<
      DecreaseSoldAmountEvent.InputTuple,
      DecreaseSoldAmountEvent.OutputTuple,
      DecreaseSoldAmountEvent.OutputObject
    >;
