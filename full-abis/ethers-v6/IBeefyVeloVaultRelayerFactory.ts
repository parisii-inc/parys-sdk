...
export interface IBeefyVeloVaultRelayerFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addAuthorization"
  ...
  encodeFunctionData(
    functionFragment: "beefyVeloVaultRelayersList",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "deployBeefyVeloVaultRelayer",
...
export namespace NewBeefyVeloVaultRelayerEvent {
  export type InputTuple = [
    _beefyVeloVaultRelayer: AddressLike,
    _beefyVault: AddressLike,
...
export interface IBeefyVeloVaultRelayerFactory extends BaseContract {
  connect(runner?: ContractRunner | null): IBeefyVeloVaultRelayerFactory;
  ...
  beefyVeloVaultRelayersList: TypedContractMethod<[], [string[]], "view">;

  deployBeefyVeloVaultRelayer: TypedContractMethod<
    [
      _beefyVault: AddressLike,
      _veloPool: AddressLike,
      _veloLpOracle: AddressLike
  ...
  getFunction(
    nameOrSignature: "beefyVeloVaultRelayersList"
  ): TypedContractMethod<[], [string[]], "view">;
  getFunction(
    nameOrSignature: "deployBeefyVeloVaultRelayer"
  ): TypedContractMethod<
    [
      _beefyVault: AddressLike,
      _veloPool: AddressLike,
  ...
  >;
  getEvent(
    key: "NewBeefyVeloVaultRelayer"
  ): TypedContractEvent<
    NewBeefyVeloVaultRelayerEvent.InputTuple,
    NewBeefyVeloVaultRelayerEvent.OutputTuple,
    NewBeefyVeloVaultRelayerEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "NewBeefyVeloVaultRelayer(address,address,address,address)": TypedContractEvent<
      NewBeefyVeloVaultRelayerEvent.InputTuple,
      NewBeefyVeloVaultRelayerEvent.OutputTuple,
      NewBeefyVeloVaultRelayerEvent.OutputObject
    >;
    NewBeefyVeloVaultRelayer: TypedContractEvent<
      NewBeefyVeloVaultRelayerEvent.InputTuple,
      NewBeefyVeloVaultRelayerEvent.OutputTuple,
      NewBeefyVeloVaultRelayerEvent.OutputObject
    >;
