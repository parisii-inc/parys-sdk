...
export interface ISurplusAuctionHouseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "AUCTION_HOUSE_TYPE"
      | "_auctions"
...
export interface ISurplusAuctionHouse extends BaseContract {
  connect(runner?: ContractRunner | null): ISurplusAuctionHouse;
