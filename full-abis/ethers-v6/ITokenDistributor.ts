...
export interface ITokenDistributorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addAuthorization"
...
export interface ITokenDistributor extends BaseContract {
  connect(runner?: ContractRunner | null): ITokenDistributor;
  ...
  claimed: TypedContractMethod<[_user: AddressLike], [boolean], "view">;
