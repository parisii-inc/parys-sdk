 ...
 */
const PEUA = '0x5045554100000000000000000000000000000000000000000000000000000000'

/**
 * byte32 value for the "PBJO" collateral
 */
const PBJO = '0x50424a4f00000000000000000000000000000000000000000000000000000000'
