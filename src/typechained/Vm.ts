...
export interface VmInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [boolean, boolean, boolean, boolean, string, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface Vm extends BaseContract {
  ...
  functions: {
    ...
    "getDeployment(string,uint64)"(
      ...
      chainId: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[string] & { deployedAddress: string }>;
    ...
    getDeployments(
      ...
      chainId: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[string[]] & { deployedAddresses: string[] }>;
    ...
    unixTime(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { milliseconds: BigNumber }>;
  ...
  callStatic: {
    ...
    signAndAttachDelegation(
      ...
      privateKey: BigNumberish,
      overrides?: CallOverrides
    ): Promise<VmSafe.SignedDelegationStructOutput>;
  ...
  estimateGas: {
    ...
    noAccessList(overrides?: Overrides & { from?: string }): Promise<BigNumber>;
