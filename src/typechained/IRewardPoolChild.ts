...
export declare namespace IRewardPool {
  ...
  export type RewardPoolParamsStructOutput = [string, BigNumber, BigNumber] & {
    stakingManager: string;
    duration: BigNumber;
...
export interface IRewardPoolChildInterface extends utils.Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: "RewardPoolEmergencyWithdrawal"
  ): EventFragment;
...
export type RewardPoolDecreaseStakeEventFilter =
  TypedEventFilter<RewardPoolDecreaseStakeEvent>;
...
export type RewardPoolEmergencyWithdrawalEventFilter =
  TypedEventFilter<RewardPoolEmergencyWithdrawalEvent>;
...
export type RewardPoolIncreaseStakeEventFilter =
  TypedEventFilter<RewardPoolIncreaseStakeEvent>;
...
export type RewardPoolRewardAddedEventFilter =
  TypedEventFilter<RewardPoolRewardAddedEvent>;
...
export type RewardPoolRewardPaidEventFilter =
  TypedEventFilter<RewardPoolRewardPaidEvent>;
...
export type RewardPoolStakedEventFilter =
  TypedEventFilter<RewardPoolStakedEvent>;
...
export type RewardPoolWithdrawnEventFilter =
  TypedEventFilter<RewardPoolWithdrawnEvent>;
...
export interface IRewardPoolChild extends BaseContract {
  ...
  functions: {
    ...
    currentRewards(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _currentRewards: BigNumber }>;
    ...
    historicalRewards(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _historicalRewards: BigNumber }>;
    ...
    lastTimeRewardApplicable(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _periodFinish: BigNumber }>;

    lastUpdateTime(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _lastUpdateTime: BigNumber }>;
    ...
    queuedRewards(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _queuedRewards: BigNumber }>;
    ...
    rewardPerToken(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _rewardPerToken: BigNumber }>;

    rewardPerTokenPaid(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _rewardPerTokenPaid: BigNumber }>;

    rewardPerTokenStored(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _rewardPerTokenStored: BigNumber }>;

    rewardRate(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _rewardRate: BigNumber }>;

    rewardToken(
      overrides?: CallOverrides
    ): Promise<[string] & { _rewardToken: string }>;
    ...
    totalStaked(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _totalStakedAmt: BigNumber }>;
  ...
  params(
    overrides?: CallOverrides
  ): Promise<IRewardPool.RewardPoolParamsStructOutput>;
  ...
  filters: {
    ...
    "RewardPoolDecreaseStake(address,uint256)"(
      _account?: string | null,
      _amount?: null
    ): RewardPoolDecreaseStakeEventFilter;
    RewardPoolDecreaseStake(
      _account?: string | null,
      _amount?: null
    ): RewardPoolDecreaseStakeEventFilter;

    "RewardPoolEmergencyWithdrawal(address,uint256)"(
      _account?: string | null,
      _amount?: null
    ): RewardPoolEmergencyWithdrawalEventFilter;
    RewardPoolEmergencyWithdrawal(
      _account?: string | null,
      _amount?: null
    ): RewardPoolEmergencyWithdrawalEventFilter;

    "RewardPoolIncreaseStake(address,uint256)"(
      _account?: string | null,
      _amount?: null
    ): RewardPoolIncreaseStakeEventFilter;
    RewardPoolIncreaseStake(
      _account?: string | null,
      _amount?: null
    ): RewardPoolIncreaseStakeEventFilter;

    "RewardPoolRewardAdded(uint256)"(
      _reward?: null
    ): RewardPoolRewardAddedEventFilter;
    RewardPoolRewardAdded(_reward?: null): RewardPoolRewardAddedEventFilter;

    "RewardPoolRewardPaid(address,uint256)"(
      _account?: string | null,
      _reward?: null
    ): RewardPoolRewardPaidEventFilter;
    RewardPoolRewardPaid(
      _account?: string | null,
      _reward?: null
    ): RewardPoolRewardPaidEventFilter;

    "RewardPoolStaked(address,uint256)"(
      _account?: string | null,
      _amount?: null
    ): RewardPoolStakedEventFilter;
    RewardPoolStaked(
      _account?: string | null,
      _amount?: null
    ): RewardPoolStakedEventFilter;

    "RewardPoolWithdrawn(address,uint256)"(
      _account?: string | null,
      _amount?: null
    ): RewardPoolWithdrawnEventFilter;
    RewardPoolWithdrawn(
      _account?: string | null,
      _amount?: null
    ): RewardPoolWithdrawnEventFilter;
