...
export interface IDelayedOracle extends BaseContract {
  ...
  functions: {
    getNextResultWithValidity(
      ...
      [BigNumber, boolean] & { _nextResult: BigNumber; _validity: boolean }
    >;
    ...
    priceSource(
      overrides?: CallOverrides
    ): Promise<[string] & { _priceSource: string }>;
    ...
    updateDelay(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _updateDelay: BigNumber }>;
  ...
  filters: {
    "UpdateResult(uint256,uint256)"(
      _currentFeedValue?: null,
      _lastUpdateTime?: null
    ): UpdateResultEventFilter;
    UpdateResult(
      _currentFeedValue?: null,
      _lastUpdateTime?: null
    ): UpdateResultEventFilter;
  ...
  estimateGas: {
    ...
    updateResult(overrides?: Overrides & { from?: string }): Promise<BigNumber>;
  };
