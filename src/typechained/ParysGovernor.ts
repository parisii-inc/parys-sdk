...
export declare namespace IParysGovernor {
  export type ParysGovernorParamsStruct = {
  ...
  export type ParysGovernorParamsStructOutput = [
    number,
    number,
    number,
    BigNumber,
...
export interface ParysGovernor extends BaseContract {
  ...
  functions: {
    ...
    proposalDeadline(
      ...
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _deadline: BigNumber }>;
    ...
    proposalNeedsQueuing(
      _proposalId: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[boolean] & { _needsQueuing: boolean }>;
