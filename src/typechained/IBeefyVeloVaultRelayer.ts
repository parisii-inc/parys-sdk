...
export interface IBeefyVeloVaultRelayerInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "token0priceSource",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "token1priceSource",
    values?: undefined
  ): string;
...
export interface IBeefyVeloVaultRelayer extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[string] & { _beefyVault: string }>;
    ...
    token0priceSource(
      overrides?: CallOverrides
    ): Promise<[string] & { _token0priceSource: string }>;

    token1priceSource(
      overrides?: CallOverrides
    ): Promise<[string] & { _token1priceSource: string }>;

    veloPool(
      overrides?: CallOverrides
    ): Promise<[string] & { _veloPool: string }>;
  };
