...
export interface CollateralAuctionHouseFactoryInterface
  ...
  getEvent(
    nameOrSignatureOrTopic: "DeployCollateralAuctionHouse"
  ): EventFragment;
...
export type DeployCollateralAuctionHouseEventFilter =
  TypedEventFilter<DeployCollateralAuctionHouseEvent>;
...
export interface CollateralAuctionHouseFactory extends BaseContract {
  ...
  functions: {
    ...
    collateralAuctionHousesList(
      overrides?: CallOverrides
    ): Promise<[string[]] & { _collateralAuctionHousesList: string[] }>;
  ...
  cParams(
    _cType: BytesLike,
    overrides?: CallOverrides
  ): Promise<ICollateralAuctionHouse.CollateralAuctionHouseParamsStructOutput>;
  ...
  filters: {
    ...
    "DeployCollateralAuctionHouse(bytes32,address)"(
      _cType?: BytesLike | null,
      _collateralAuctionHouse?: string | null
    ): DeployCollateralAuctionHouseEventFilter;
