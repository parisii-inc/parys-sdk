...
export declare namespace ILiquidationEngine {
  ...
  export type LiquidationEngineParamsStructOutput = [BigNumber, BigNumber] & {
...
export interface LiquidationEngineInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "attemptSave",
    values: [BytesLike, string, string, ISAFEEngine.SAFEStruct]
  ): string;
  encodeFunctionData(
  ...
  getEvent(
    nameOrSignatureOrTopic: "UpdateCurrentOnAuctionSystemCoins"
  ): EventFragment;
}
...
export type ConnectSAFESaviourEventFilter =
  TypedEventFilter<ConnectSAFESaviourEvent>;
...
export type DisconnectSAFESaviourEventFilter =
  TypedEventFilter<DisconnectSAFESaviourEvent>;
...
export type UpdateCurrentOnAuctionSystemCoinsEventFilter =
  TypedEventFilter<UpdateCurrentOnAuctionSystemCoinsEvent>;
...
export interface LiquidationEngine extends BaseContract {
  ...
  functions: {
    ...
    attemptSave(
      ...
      _safe: string,
      _liquidator: string,
      _safeData: ISAFEEngine.SAFEStruct,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    chosenSAFESaviour(
      ...
      _safe: string,
      overrides?: CallOverrides
    ): Promise<[string] & { _saviour: string }>;
    ...
    getLimitAdjustedDebtToCover(
      ...
      _safe: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _limitAdjustedDebtToCover: BigNumber }>;
  ...
  cParams(
    _cType: BytesLike,
    overrides?: CallOverrides
  ): Promise<ILiquidationEngine.LiquidationEngineCollateralParamsStructOutput>;
  ...
  params(
    overrides?: CallOverrides
  ): Promise<ILiquidationEngine.LiquidationEngineParamsStructOutput>;
  ...
  filters: {
    ...
    "DisconnectSAFESaviour(address)"(
      _saviour?: null
    ): DisconnectSAFESaviourEventFilter;
    ...
    "Liquidate(bytes32,address,uint256,uint256,uint256,address,uint256)"(
      _cType?: BytesLike | null,
      _safe?: string | null,
      _collateralAmount?: null,
      _debtAmount?: null,
      _amountToRaise?: null,
      _collateralAuctioneer?: null,
      _auctionId?: null
    ...
    "SaveSAFE(bytes32,address,uint256)"(
      _cType?: BytesLike | null,
      _safe?: string | null,
      _collateralAddedOrDebtRepaid?: null
    ): SaveSAFEEventFilter;
    SaveSAFE(
      _cType?: BytesLike | null,
      _safe?: string | null,
    ...
    "UpdateCurrentOnAuctionSystemCoins(uint256)"(
      _currentOnAuctionSystemCoins?: null
    ): UpdateCurrentOnAuctionSystemCoinsEventFilter;
