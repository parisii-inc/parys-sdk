...
export type DeployCollateralJoinEventFilter =
  TypedEventFilter<DeployCollateralJoinEvent>;
...
export type DisableCollateralJoinEventFilter =
  TypedEventFilter<DisableCollateralJoinEvent>;
...
export interface ICollateralJoinFactory extends BaseContract {
  ...
  functions: {
    ...
    collateralJoins(
      _cType: BytesLike,
      overrides?: CallOverrides
    ): Promise<[string] & { _collateralJoin: string }>;

    collateralJoinsList(
      overrides?: CallOverrides
    ): Promise<[string[]] & { _collateralJoinsList: string[] }>;

    collateralTypesList(
      overrides?: CallOverrides
    ): Promise<[string[]] & { _collateralTypesList: string[] }>;
  ...
  filters: {
    ...
    "DeployCollateralJoin(bytes32,address,address)"(
      ...
      _collateralJoin?: string | null
    ): DeployCollateralJoinEventFilter;
    DeployCollateralJoin(
      _cType?: BytesLike | null,
      _collateral?: string | null,
      _collateralJoin?: string | null
    ...
    "DisableCollateralJoin(address)"(
      _collateralJoin?: string | null
    ): DisableCollateralJoinEventFilter;
    DisableCollateralJoin(
      _collateralJoin?: string | null
    ): DisableCollateralJoinEventFilter;
