...
export interface IYearnVeloVaultRelayerFactoryInterface
...
export type NewYearnVeloVaultRelayerEventFilter =
  TypedEventFilter<NewYearnVeloVaultRelayerEvent>;
...
export interface IYearnVeloVaultRelayerFactory extends BaseContract {
  ...
  functions: {
    ...
    yearnVeloVaultRelayersList(
      overrides?: CallOverrides
    ): Promise<[string[]] & { _yearnVeloVaultRelayersList: string[] }>;
  };
  ...
  filters: {
    ...
    "NewYearnVeloVaultRelayer(address,address,address,address)"(
      _yearnVeloVaultRelayer?: string | null,
      _yearnVault?: null,
      _veloPool?: null,
      _veloLpOracle?: null
    ): NewYearnVeloVaultRelayerEventFilter;
