...
export declare namespace IParysSafeManager {
  ...
  export type SAFEDataStructOutput = [string, string, string, string] & {
    owner: string;
    pendingOwner: string;
    safeHandler: string;
...
export interface ParysSafeManagerInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "isSafeHandler",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  getEvent(
    nameOrSignatureOrTopic: "InitiateTransferSAFEOwnership"
  ): EventFragment;
  getEvent(
  ...
  getEvent(
    nameOrSignatureOrTopic: "TransferCollateral(address,uint256,address,uint256)"
  ): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "TransferCollateral(address,bytes32,uint256,address,uint256)"
  ): EventFragment;
...
export type InitiateTransferSAFEOwnershipEventFilter =
  TypedEventFilter<InitiateTransferSAFEOwnershipEvent>;
...
export type TransferCollateral_address_uint256_address_uint256_Event =
  TypedEvent<
...
export type TransferCollateral_address_bytes32_uint256_address_uint256_Event =
  TypedEvent<
...
export type TransferSAFEOwnershipEventFilter =
  TypedEventFilter<TransferSAFEOwnershipEvent>;
...
export interface ParysSafeManager extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[BigNumber[]] & { _safes: BigNumber[] }>;
  ...
  safeData(
    _safe: BigNumberish,
    overrides?: CallOverrides
  ): Promise<IParysSafeManager.SAFEDataStructOutput>;
  ...
  filters: {
    "AllowHandler(address,address,bool)"(
      _sender?: string | null,
      _usr?: null,
      _ok?: null
    ): AllowHandlerEventFilter;
    AllowHandler(
      _sender?: string | null,
      _usr?: null,
      _ok?: null
    ...
    "AllowSAFE(address,uint256,address,bool)"(
      _sender?: string | null,
      _safe?: BigNumberish | null,
      _usr?: null,
      _ok?: null
    ...
    "InitiateTransferSAFEOwnership(address,uint256,address)"(
      _sender?: string | null,
      _safe?: BigNumberish | null,
      _dst?: null
    ): InitiateTransferSAFEOwnershipEventFilter;
    ...
    "MoveSAFE(address,uint256,uint256)"(
      _sender?: string | null,
      _safeSrc?: BigNumberish | null,
      _safeDst?: BigNumberish | null
    ): MoveSAFEEventFilter;
    MoveSAFE(
      _sender?: string | null,
      _safeSrc?: BigNumberish | null,
