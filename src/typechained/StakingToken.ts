...
export type StakingTokenBurnEventFilter =
  TypedEventFilter<StakingTokenBurnEvent>;
...
export type StakingTokenMintEventFilter =
  TypedEventFilter<StakingTokenMintEvent>;
...
export type StakingTokenPauseEventFilter =
  TypedEventFilter<StakingTokenPauseEvent>;
...
export type StakingTokenUnpauseEventFilter =
  TypedEventFilter<StakingTokenUnpauseEvent>;
...
export interface StakingToken extends BaseContract {
  ...
  filters: {
    ...
    "StakingTokenBurn(address,uint256)"(
      _src?: string | null,
      _wad?: null
    ): StakingTokenBurnEventFilter;
    StakingTokenBurn(
      _src?: string | null,
      _wad?: null
    ): StakingTokenBurnEventFilter;

    "StakingTokenMint(address,uint256)"(
      _dst?: string | null,
      _wad?: null
    ): StakingTokenMintEventFilter;
    StakingTokenMint(
      _dst?: string | null,
      _wad?: null
    ): StakingTokenMintEventFilter;
