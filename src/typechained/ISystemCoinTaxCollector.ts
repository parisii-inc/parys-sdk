...
export interface ISystemCoinTaxCollector extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[BigNumber] & { _maxTaxRateBasisPoints: BigNumber }>;
    ...
    customTaxRates(
      _account: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _customTaxRate: BigNumber }>;

    defaultTaxRateBasisPoints(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _defaultTaxRateBasisPoints: BigNumber }>;

    exemptAddresses(
      _account: string,
      overrides?: CallOverrides
    ): Promise<[boolean] & { _isExempt: boolean }>;

    getTaxRate(
      _account: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _taxRate: BigNumber }>;

    hasCustomRate(
      _account: string,
      overrides?: CallOverrides
    ): Promise<[boolean] & { _hasCustomRate: boolean }>;
