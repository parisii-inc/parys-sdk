...
export declare namespace IStabilityFeeTreasury {
  ...
  export type AllowanceStructOutput = [BigNumber, BigNumber] & {
    total: BigNumber;
    perHour: BigNumber;
  };
...
export type SetPerHourAllowanceEventFilter =
  TypedEventFilter<SetPerHourAllowanceEvent>;
...
export type SetTotalAllowanceEventFilter =
  TypedEventFilter<SetTotalAllowanceEvent>;
...
export type TransferSurplusFundsEventFilter =
  TypedEventFilter<TransferSurplusFundsEvent>;
...
export interface IStabilityFeeTreasury extends BaseContract {
  ...
  functions: {
    _allowance(
      ...
      [BigNumber, BigNumber] & { _total: BigNumber; _perHour: BigNumber }
    >;
    ...
    latestSurplusTransferTime(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _latestSurplusTransferTime: BigNumber }>;
    ...
    pulledPerHour(
      _account: string,
      _blockHour: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _pulledPerHour: BigNumber }>;
    ...
    systemCoin(
      overrides?: CallOverrides
    ): Promise<[string] & { _systemCoin: string }>;
  ...
  allowance(
    _account: string,
    overrides?: CallOverrides
  ): Promise<IStabilityFeeTreasury.AllowanceStructOutput>;
  ...
  params(
    overrides?: CallOverrides
  ): Promise<IStabilityFeeTreasury.StabilityFeeTreasuryParamsStructOutput>;
  ...
  filters: {
    ...
    "GiveFunds(address,uint256)"(
      _account?: string | null,
      _rad?: null
    ): GiveFundsEventFilter;
    ...
    "PullFunds(address,address,uint256)"(
      _sender?: string | null,
      _dstAccount?: string | null,
      _rad?: null
    ): PullFundsEventFilter;
    PullFunds(
      _sender?: string | null,
      _dstAccount?: string | null,
      _rad?: null
    ...
    "SetPerHourAllowance(address,uint256)"(
      _account?: string | null,
      _rad?: null
    ): SetPerHourAllowanceEventFilter;
    SetPerHourAllowance(
      _account?: string | null,
      _rad?: null
    ): SetPerHourAllowanceEventFilter;

    "SetTotalAllowance(address,uint256)"(
      _account?: string | null,
      _rad?: null
    ): SetTotalAllowanceEventFilter;
    SetTotalAllowance(
      _account?: string | null,
      _rad?: null
    ): SetTotalAllowanceEventFilter;
    ...
    "TakeFunds(address,uint256)"(
      _account?: string | null,
      _rad?: null
    ): TakeFundsEventFilter;
    TakeFunds(_account?: string | null, _rad?: null): TakeFundsEventFilter;

    "TransferSurplusFunds(address,uint256)"(
      _extraSurplusReceiver?: null,
      _fundsToTransfer?: null
    ): TransferSurplusFundsEventFilter;
    TransferSurplusFunds(
      _extraSurplusReceiver?: null,
      _fundsToTransfer?: null
    ): TransferSurplusFundsEventFilter;
  ...
  estimateGas: {
    ...
    settleDebt(overrides?: Overrides & { from?: string }): Promise<BigNumber>;
