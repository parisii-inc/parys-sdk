...
export interface ICollateralJoinDelegatableChildInterface
...
export interface ICollateralJoinDelegatableChild extends BaseContract {
  ...
  functions: {
    ...
    collateral(
      overrides?: CallOverrides
    ): Promise<[string] & { _collateral: string }>;
    ...
    decimals(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _decimals: BigNumber }>;

    delegatee(
      overrides?: CallOverrides
    ): Promise<[string] & { _delegatee: string }>;
