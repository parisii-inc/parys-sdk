...
export declare namespace IStakingManager {
  ...
  export type StakingManagerParamsStructOutput = [BigNumber] & {
  ...
  export type PendingWithdrawalStructOutput = [BigNumber, BigNumber] & {
    amount: BigNumber;
    timestamp: BigNumber;
  };
...
export interface IStakingManagerInterface extends utils.Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: "StakingManagerActivateRewardType"
  ): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "StakingManagerAddRewardType"
  ): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "StakingManagerDeactivateRewardType"
  ): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "StakingManagerEmergencyRewardWithdrawal"
  ): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "StakingManagerEmergencyWithdrawal"
  ): EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "StakingManagerWithdrawalCancelled"
  ): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "StakingManagerWithdrawalInitiated"
  ): EventFragment;
...
export type StakingManagerActivateRewardTypeEventFilter =
  TypedEventFilter<StakingManagerActivateRewardTypeEvent>;
...
export type StakingManagerAddRewardTypeEventFilter =
  TypedEventFilter<StakingManagerAddRewardTypeEvent>;
...
export type StakingManagerDeactivateRewardTypeEventFilter =
  TypedEventFilter<StakingManagerDeactivateRewardTypeEvent>;
...
export type StakingManagerEmergencyRewardWithdrawalEventFilter =
  TypedEventFilter<StakingManagerEmergencyRewardWithdrawalEvent>;
...
export type StakingManagerEmergencyWithdrawalEventFilter =
  TypedEventFilter<StakingManagerEmergencyWithdrawalEvent>;
...
export type StakingManagerRewardPaidEventFilter =
  TypedEventFilter<StakingManagerRewardPaidEvent>;
...
export type StakingManagerStakedEventFilter =
  TypedEventFilter<StakingManagerStakedEvent>;
...
export type StakingManagerWithdrawalCancelledEventFilter =
  TypedEventFilter<StakingManagerWithdrawalCancelledEvent>;
...
export type StakingManagerWithdrawalInitiatedEventFilter =
  TypedEventFilter<StakingManagerWithdrawalInitiatedEvent>;
...
export type StakingManagerWithdrawnEventFilter =
  TypedEventFilter<StakingManagerWithdrawnEvent>;
...
export interface IStakingManager extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[BigNumber] & { _cooldownPeriod: BigNumber }>;

    _pendingWithdrawals(
      _account: string,
      overrides?: CallOverrides
    ): Promise<
      [BigNumber, BigNumber] & { _amount: BigNumber; _timestamp: BigNumber }
    >;
    ...
    claimableReward(
      ...
      _user: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _claimableReward: BigNumber }>;
    ...
    rewardIntegralFor(
      ...
      _user: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _rewardIntegral: BigNumber }>;
    ...
    stakedBalances(
      _account: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _stakedBalance: BigNumber }>;

    stakedSupply(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _stakedSupply: BigNumber }>;

    stakingToken(
      overrides?: CallOverrides
    ): Promise<[string] & { _stakingToken: string }>;
  ...
  params(
    overrides?: CallOverrides
  ): Promise<IStakingManager.StakingManagerParamsStructOutput>;

  pendingWithdrawals(
    _account: string,
    overrides?: CallOverrides
  ): Promise<IStakingManager.PendingWithdrawalStructOutput>;
  ...
  rewardTypes(
    _id: BigNumberish,
    overrides?: CallOverrides
  ): Promise<IStakingManager.RewardTypeInfoStructOutput>;
  ...
  callStatic: {
    ...
    earned(
      _account: string,
      overrides?: CallOverrides
    ): Promise<IStakingManager.EarnedDataStructOutput[]>;
  ...
  filters: {
    ...
    "StakingManagerActivateRewardType(uint256)"(
      _id?: BigNumberish | null
    ): StakingManagerActivateRewardTypeEventFilter;
    StakingManagerActivateRewardType(
      _id?: BigNumberish | null
    ): StakingManagerActivateRewardTypeEventFilter;

    "StakingManagerAddRewardType(uint256,address,address)"(
      _id?: BigNumberish | null,
      _rewardToken?: string | null,
      _rewardPool?: string | null
    ): StakingManagerAddRewardTypeEventFilter;
    ...
    "StakingManagerDeactivateRewardType(uint256)"(
      _id?: BigNumberish | null
    ): StakingManagerDeactivateRewardTypeEventFilter;
    StakingManagerDeactivateRewardType(
      _id?: BigNumberish | null
    ): StakingManagerDeactivateRewardTypeEventFilter;

    "StakingManagerEmergencyRewardWithdrawal(address,address,uint256)"(
      _account?: string | null,
      _rewardToken?: string | null,
      _wad?: null
    ): StakingManagerEmergencyRewardWithdrawalEventFilter;
    ...
    "StakingManagerEmergencyWithdrawal(address,uint256)"(
      _account?: string | null,
      _wad?: null
    ): StakingManagerEmergencyWithdrawalEventFilter;
    StakingManagerEmergencyWithdrawal(
      _account?: string | null,
      _wad?: null
    ): StakingManagerEmergencyWithdrawalEventFilter;

    "StakingManagerRewardPaid(address,address,uint256,address)"(
      _account?: string | null,
      _rewardToken?: string | null,
      _wad?: null,
      _destination?: string | null
    ): StakingManagerRewardPaidEventFilter;
    ...
    "StakingManagerStaked(address,uint256)"(
      _account?: string | null,
      _wad?: null
    ): StakingManagerStakedEventFilter;
    StakingManagerStaked(
      _account?: string | null,
      _wad?: null
    ): StakingManagerStakedEventFilter;

    "StakingManagerWithdrawalCancelled(address,uint256)"(
      _account?: string | null,
      _wad?: null
    ): StakingManagerWithdrawalCancelledEventFilter;
    StakingManagerWithdrawalCancelled(
      _account?: string | null,
      _wad?: null
    ): StakingManagerWithdrawalCancelledEventFilter;

    "StakingManagerWithdrawalInitiated(address,uint256)"(
      _account?: string | null,
      _wad?: null
    ): StakingManagerWithdrawalInitiatedEventFilter;
    StakingManagerWithdrawalInitiated(
      _account?: string | null,
      _wad?: null
    ): StakingManagerWithdrawalInitiatedEventFilter;

    "StakingManagerWithdrawn(address,uint256)"(
      _account?: string | null,
      _wad?: null
    ): StakingManagerWithdrawnEventFilter;
