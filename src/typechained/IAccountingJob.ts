...
export interface IAccountingJob extends BaseContract {
  ...
  functions: {
    ...
    shouldWorkAuctionDebt(
      overrides?: CallOverrides
    ): Promise<[boolean] & { _shouldWorkAuctionDebt: boolean }>;

    shouldWorkAuctionSurplus(
      overrides?: CallOverrides
    ): Promise<[boolean] & { _shouldWorkAuctionSurplus: boolean }>;

    shouldWorkPopDebtFromQueue(
      overrides?: CallOverrides
    ): Promise<[boolean] & { _shouldWorkPopDebtFromQueue: boolean }>;

    shouldWorkTransferExtraSurplus(
      overrides?: CallOverrides
    ): Promise<[boolean] & { _shouldWorkTransferExtraSurplus: boolean }>;
