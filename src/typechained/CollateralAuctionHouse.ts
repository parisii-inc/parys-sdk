...
export interface CollateralAuctionHouse extends BaseContract {
  ...
  functions: {
    ...
    getAuctionDiscount(
      _id: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _auctionDiscount: BigNumber }>;
    ...
    liquidationEngine(
      overrides?: CallOverrides
    ): Promise<[string] & { __liquidationEngine: string }>;
    ...
    oracleRelayer(
      overrides?: CallOverrides
    ): Promise<[string] & { __oracleRelayer: string }>;
  ...
  auctions(
    _auctionId: BigNumberish,
    overrides?: CallOverrides
  ): Promise<ICollateralAuctionHouse.AuctionStructOutput>;
  ...
  filters: {
    ...
    "BuyCollateral(uint256,address,uint256,uint256,uint256)"(
    ...
    "SettleAuction(uint256,uint256,address,uint256)"(
      _id?: BigNumberish | null,
      _blockTimestamp?: null,
      _leftoverReceiver?: null,
      _leftoverCollateral?: null
