...
export interface IBeefyVeloVaultRelayerFactoryInterface
...
export type NewBeefyVeloVaultRelayerEventFilter =
  TypedEventFilter<NewBeefyVeloVaultRelayerEvent>;
...
export interface IBeefyVeloVaultRelayerFactory extends BaseContract {
  ...
  functions: {
    ...
    beefyVeloVaultRelayersList(
      overrides?: CallOverrides
    ): Promise<[string[]] & { _beefyVeloVaultRelayersList: string[] }>;
  ...
  filters: {
    ...
    "NewBeefyVeloVaultRelayer(address,address,address,address,address)"(
      _beefyVeloVaultRelayer?: string | null,
      _token0priceSource?: null,
      _token1priceSource?: null,
      _beefyVault?: null,
      _veloPool?: null
    ): NewBeefyVeloVaultRelayerEventFilter;
