...
export type DeployRewardPoolEventFilter =
  TypedEventFilter<DeployRewardPoolEvent>;
...
export interface IRewardPoolFactory extends BaseContract {
  ...
  functions: {
    ...
    rewardPoolsList(
      overrides?: CallOverrides
    ): Promise<[string[]] & { _rewardPoolsList: string[] }>;
  };
  ...
  filters: {
    ...
    "DeployRewardPool(address,address,address,uint256,uint256)"(
      _rewardPool?: string | null,
      _rewardToken?: string | null,
      _stakingManager?: string | null,
      _duration?: null,
      _newRewardRatio?: null
    ): DeployRewardPoolEventFilter;
    DeployRewardPool(
      _rewardPool?: string | null,
      _rewardToken?: string | null,
      _stakingManager?: string | null,
