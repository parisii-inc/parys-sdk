...
export type NewDenominatedOracleEventFilter =
  TypedEventFilter<NewDenominatedOracleEvent>;
...
export interface DenominatedOracleFactory extends BaseContract {
  ...
  functions: {
    ...
    denominatedOraclesList(
      overrides?: CallOverrides
    ): Promise<[string[]] & { _denominatedOraclesList: string[] }>;
  ...
  filters: {
    ...
    "NewDenominatedOracle(address,address,address,bool)"(
      _denominatedOracle?: string | null,
      _priceSource?: null,
      _denominationPriceSource?: null,
      _inverted?: null
    ): NewDenominatedOracleEventFilter;
