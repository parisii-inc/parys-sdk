...
export interface SystemCoinTaxCollectorInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "MAX_TAX_RATE_BASIS_POINTS",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "customTaxRates",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "defaultTaxRateBasisPoints",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "hasCustomRate",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "isAddressExemptForTransfer",
  ...
  encodeFunctionData(
    functionFragment: "removeCustomTaxRate",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setCustomTaxRate",
...
export type CustomTaxRateSetEventFilter =
  TypedEventFilter<CustomTaxRateSetEvent>;
...
export type DefaultTaxRateChangedEventFilter =
  TypedEventFilter<DefaultTaxRateChangedEvent>;
...
export type ExemptionStatusChangedEventFilter =
  TypedEventFilter<ExemptionStatusChangedEvent>;
...
export interface SystemCoinTaxCollector extends BaseContract {
  ...
  functions: {
    ...
    setCustomTaxRate(
      _account: string,
      _customTaxRateBasisPoints: BigNumberish,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;

    setDefaultTaxRate(
      _newDefaultTaxRateBasisPoints: BigNumberish,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "CustomTaxRateSet(address,uint256,uint256)"(
      _account?: string | null,
      _oldRate?: null,
      _newRate?: null
    ): CustomTaxRateSetEventFilter;
    CustomTaxRateSet(
      _account?: string | null,
      _oldRate?: null,
      _newRate?: null
    ...
    "DefaultTaxRateChanged(uint256,uint256)"(
      _oldRate?: null,
      _newRate?: null
    ): DefaultTaxRateChangedEventFilter;
    DefaultTaxRateChanged(
      _oldRate?: null,
      _newRate?: null
    ): DefaultTaxRateChangedEventFilter;

    "ExemptionStatusChanged(address,bool,bool)"(
      account?: string | null,
      oldStatus?: null,
      newStatus?: null
    ): ExemptionStatusChangedEventFilter;
    ExemptionStatusChanged(
      account?: string | null,
      oldStatus?: null,
      newStatus?: null
    ): ExemptionStatusChangedEventFilter;
    ...
    "ProxyFactorySet(address)"(
      proxyFactory?: string | null
    ): ProxyFactorySetEventFilter;
    ...
    "TaxCollected(address,address,uint256,uint256,uint256)"(
      _from?: string | null,
      _to?: string | null,
      _amount?: null,
      _taxAmount?: null,
      _appliedRate?: null
    ): TaxCollectedEventFilter;
    TaxCollected(
      _from?: string | null,
      _to?: string | null,
      _amount?: null,
