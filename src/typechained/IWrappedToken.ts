...
export type WrappedTokenDepositEventFilter =
  TypedEventFilter<WrappedTokenDepositEvent>;
...
export interface IWrappedToken extends BaseContract {
  ...
  functions: {
    ...
    baseTokenManager(
      overrides?: CallOverrides
    ): Promise<[string] & { _baseTokenManager: string }>;
  ...
  filters: {
    ...
    "WrappedTokenDeposit(address,uint256)"(
      _account?: string | null,
      _wad?: null
    ): WrappedTokenDepositEventFilter;
    WrappedTokenDeposit(
      _account?: string | null,
      _wad?: null
    ): WrappedTokenDepositEventFilter;
