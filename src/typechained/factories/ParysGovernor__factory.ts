...
export class ParysGovernor__factory {
  static readonly abi = _abi;
  static createInterface(): ParysGovernorInterface {
    return new utils.Interface(_abi) as ParysGovernorInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ParysGovernor {
    return new Contract(address, _abi, signerOrProvider) as ParysGovernor;
  }
}
