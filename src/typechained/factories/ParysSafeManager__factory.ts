...
import type {
  ParysSafeManager,
  ParysSafeManagerInterface,
} from "../ParysSafeManager";
...
export class ParysSafeManager__factory {
  static readonly abi = _abi;
  static createInterface(): ParysSafeManagerInterface {
    return new utils.Interface(_abi) as ParysSafeManagerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ParysSafeManager {
    return new Contract(address, _abi, signerOrProvider) as ParysSafeManager;
  }
}
