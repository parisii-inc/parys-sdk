...
import type {
  SurplusAuctionHouse,
  SurplusAuctionHouseInterface,
  ISurplusAuctionHouse,
} from "../SurplusAuctionHouse";
...
export class SurplusAuctionHouse__factory {
  static readonly abi = _abi;
  static createInterface(): SurplusAuctionHouseInterface {
    return new utils.Interface(_abi) as SurplusAuctionHouseInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SurplusAuctionHouse {
    return new Contract(address, _abi, signerOrProvider) as SurplusAuctionHouse;
  }
}
