...
import type {
  ...
  SystemCoinTaxCollectorInterface,
} from "../SystemCoinTaxCollector";
...
export class SystemCoinTaxCollector__factory {
  static readonly abi = _abi;
  static createInterface(): SystemCoinTaxCollectorInterface {
    return new utils.Interface(_abi) as SystemCoinTaxCollectorInterface;
  }
  static connect(
    address: string,
