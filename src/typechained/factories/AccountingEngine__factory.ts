...
export class AccountingEngine__factory {
  static readonly abi = _abi;
  static createInterface(): AccountingEngineInterface {
    return new utils.Interface(_abi) as AccountingEngineInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AccountingEngine {
    return new Contract(address, _abi, signerOrProvider) as AccountingEngine;
  }
}
