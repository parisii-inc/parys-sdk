...
import type {
  ...
  StabilityFeeTreasuryInterface,
  IStabilityFeeTreasury,
} from "../StabilityFeeTreasury";
...
export class StabilityFeeTreasury__factory {
  static readonly abi = _abi;
  static createInterface(): StabilityFeeTreasuryInterface {
    return new utils.Interface(_abi) as StabilityFeeTreasuryInterface;
  }
  static connect(
    address: string,
