...
export class OracleRelayer__factory {
  static readonly abi = _abi;
  static createInterface(): OracleRelayerInterface {
    return new utils.Interface(_abi) as OracleRelayerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): OracleRelayer {
    return new Contract(address, _abi, signerOrProvider) as OracleRelayer;
  }
}
