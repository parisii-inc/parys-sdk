...
import type {
  ...
  SettlementSurplusAuctioneerInterface,
} from "../SettlementSurplusAuctioneer";
...
export class SettlementSurplusAuctioneer__factory {
  static readonly abi = _abi;
  static createInterface(): SettlementSurplusAuctioneerInterface {
    return new utils.Interface(_abi) as SettlementSurplusAuctioneerInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as SettlementSurplusAuctioneer;
  }
}
