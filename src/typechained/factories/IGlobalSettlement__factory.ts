...
import type {
  IGlobalSettlement,
  IGlobalSettlementInterface,
} from "../IGlobalSettlement";
...
export class IGlobalSettlement__factory {
  static readonly abi = _abi;
  static createInterface(): IGlobalSettlementInterface {
    return new utils.Interface(_abi) as IGlobalSettlementInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IGlobalSettlement {
    return new Contract(address, _abi, signerOrProvider) as IGlobalSettlement;
  }
}
