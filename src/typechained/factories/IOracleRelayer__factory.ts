...
export class IOracleRelayer__factory {
  static readonly abi = _abi;
  static createInterface(): IOracleRelayerInterface {
    return new utils.Interface(_abi) as IOracleRelayerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IOracleRelayer {
    return new Contract(address, _abi, signerOrProvider) as IOracleRelayer;
  }
}
