...
export class PIDController__factory {
  static readonly abi = _abi;
  static createInterface(): PIDControllerInterface {
    return new utils.Interface(_abi) as PIDControllerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PIDController {
    return new Contract(address, _abi, signerOrProvider) as PIDController;
  }
}
