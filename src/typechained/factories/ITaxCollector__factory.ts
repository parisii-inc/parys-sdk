...
export class ITaxCollector__factory {
  static readonly abi = _abi;
  static createInterface(): ITaxCollectorInterface {
    return new utils.Interface(_abi) as ITaxCollectorInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ITaxCollector {
    return new Contract(address, _abi, signerOrProvider) as ITaxCollector;
  }
}
