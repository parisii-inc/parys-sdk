...
export class DebtBidActions__factory {
  static readonly abi = _abi;
  static createInterface(): DebtBidActionsInterface {
    return new utils.Interface(_abi) as DebtBidActionsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): DebtBidActions {
    return new Contract(address, _abi, signerOrProvider) as DebtBidActions;
  }
}
