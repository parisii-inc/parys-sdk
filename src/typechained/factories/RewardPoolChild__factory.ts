...
import type {
  RewardPoolChild,
  RewardPoolChildInterface,
} from "../RewardPoolChild";
...
export class RewardPoolChild__factory {
  static readonly abi = _abi;
  static createInterface(): RewardPoolChildInterface {
    return new utils.Interface(_abi) as RewardPoolChildInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RewardPoolChild {
    return new Contract(address, _abi, signerOrProvider) as RewardPoolChild;
  }
}
