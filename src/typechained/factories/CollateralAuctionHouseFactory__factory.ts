...
import type {
  ...
  CollateralAuctionHouseFactoryInterface,
} from "../CollateralAuctionHouseFactory";
...
export class CollateralAuctionHouseFactory__factory {
  static readonly abi = _abi;
  static createInterface(): CollateralAuctionHouseFactoryInterface {
    return new utils.Interface(_abi) as CollateralAuctionHouseFactoryInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as CollateralAuctionHouseFactory;
  }
}
