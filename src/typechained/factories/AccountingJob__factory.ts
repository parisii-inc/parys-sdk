...
export class AccountingJob__factory {
  static readonly abi = _abi;
  static createInterface(): AccountingJobInterface {
    return new utils.Interface(_abi) as AccountingJobInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AccountingJob {
    return new Contract(address, _abi, signerOrProvider) as AccountingJob;
  }
}
