...
import type {
  ...
  CollateralAuctionHouseChildInterface,
  ICollateralAuctionHouse,
} from "../CollateralAuctionHouseChild";
...
export class CollateralAuctionHouseChild__factory {
  static readonly abi = _abi;
  static createInterface(): CollateralAuctionHouseChildInterface {
    return new utils.Interface(_abi) as CollateralAuctionHouseChildInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as CollateralAuctionHouseChild;
  }
}
