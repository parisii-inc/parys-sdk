...
export declare namespace IPIDRateSetter {
  ...
  export type PIDRateSetterParamsStructOutput = [BigNumber] & {
...
export interface PIDRateSetter extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[BigNumber] & { updateRateDelay: BigNumber }>;
  ...
  params(
    overrides?: CallOverrides
  ): Promise<IPIDRateSetter.PIDRateSetterParamsStructOutput>;
  ...
  filters: {
    ...
    "UpdateRedemptionRate(uint256,uint256,uint256)"(
      _marketPrice?: null,
  ...
  estimateGas: {
    ...
    updateRate(overrides?: Overrides & { from?: string }): Promise<BigNumber>;
  };
