...
export interface SAFEEngine extends BaseContract {
  ...
  functions: {
    ...
    _cParams(
      ...
      [BigNumber, BigNumber] & { debtCeiling: BigNumber; debtFloor: BigNumber }
    >;
    ...
    canModifySAFE(
      ...
      _account: string,
      overrides?: CallOverrides
    ): Promise<[boolean] & { _canModifySafe: boolean }>;

    coinBalance(
      _safe: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _rad: BigNumber }>;
    ...
    safeRights(
      ...
      _account: string,
      overrides?: CallOverrides
    ): Promise<[boolean] & { _isAllowed: boolean }>;
    ...
    tokenCollateral(
      ...
      _safe: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _wad: BigNumber }>;
