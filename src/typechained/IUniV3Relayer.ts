...
export interface IUniV3Relayer extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[BigNumber] & { _baseAmount: BigNumber }>;

    baseToken(
      overrides?: CallOverrides
    ): Promise<[string] & { _baseToken: string }>;
    ...
    quotePeriod(
      overrides?: CallOverrides
    ): Promise<[number] & { _quotePeriod: number }>;

    quoteToken(
      overrides?: CallOverrides
    ): Promise<[string] & { _quoteToken: string }>;
    ...
    uniV3Pool(
      overrides?: CallOverrides
    ): Promise<[string] & { _uniV3Pool: string }>;
  };
