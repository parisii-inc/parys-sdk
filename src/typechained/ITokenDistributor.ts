...
export interface ITokenDistributor extends BaseContract {
  ...
  functions: {
    ...
    claimPeriodEnd(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _claimPeriodEnd: BigNumber }>;

    claimPeriodStart(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _claimPeriodStart: BigNumber }>;

    claimed(
      _user: string,
      overrides?: CallOverrides
    ): Promise<[boolean] & { _claimed: boolean }>;
    ...
    root(overrides?: CallOverrides): Promise<[string] & { _root: string }>;
    ...
    totalClaimable(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _totalClaimable: BigNumber }>;
  };
