...
export type NewChainlinkRelayerEventFilter =
  TypedEventFilter<NewChainlinkRelayerEvent>;
...
export interface ChainlinkRelayerFactory extends BaseContract {
  ...
  functions: {
    ...
    chainlinkRelayersList(
      overrides?: CallOverrides
    ): Promise<[string[]] & { _chainlinkRelayersList: string[] }>;
  ...
  filters: {
    ...
    "NewChainlinkRelayer(address,address,address,uint256)"(
      _chainlinkRelayer?: string | null,
      _priceFeed?: null,
      _sequencerUptimeFeed?: null,
      _staleThreshold?: null
    ): NewChainlinkRelayerEventFilter;
    NewChainlinkRelayer(
      _chainlinkRelayer?: string | null,
      _priceFeed?: null,
      _sequencerUptimeFeed?: null,
