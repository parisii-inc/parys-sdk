...
export interface IRewardDistributorInterface extends utils.Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: "RewardDistributorEmergencyWithdrawal"
  ): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "RewardDistributorMerkleRootUpdated"
  ): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "RewardDistributorRewardClaimed"
  ): EventFragment;
}
...
export type RewardDistributorEmergencyWithdrawalEventFilter =
  TypedEventFilter<RewardDistributorEmergencyWithdrawalEvent>;
...
export type RewardDistributorMerkleRootUpdatedEventFilter =
  TypedEventFilter<RewardDistributorMerkleRootUpdatedEvent>;
...
export type RewardDistributorRewardClaimedEventFilter =
  TypedEventFilter<RewardDistributorRewardClaimedEvent>;
...
export interface IRewardDistributor extends BaseContract {
  ...
  functions: {
    ...
    epochCounter(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _epochCounter: BigNumber }>;

    epochDuration(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _epochDuration: BigNumber }>;
    ...
    lastUpdatedTime(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _lastUpdatedTime: BigNumber }>;

    merkleRoots(
      _token: string,
      overrides?: CallOverrides
    ): Promise<[string] & { _root: string }>;
    ...
    rootSetter(
      overrides?: CallOverrides
    ): Promise<[string] & { _rootSetter: string }>;
  ...
  filters: {
    ...
    "RewardDistributorEmergencyWithdrawal(address,address,uint256)"(
      _rescueReceiver?: string | null,
      _rewardToken?: string | null,
      _wad?: null
    ): RewardDistributorEmergencyWithdrawalEventFilter;
    ...
    "RewardDistributorMerkleRootUpdated(address,bytes32,uint256)"(
      _rewardToken?: string | null,
      _merkleRoot?: null,
      _epochCounter?: null
    ): RewardDistributorMerkleRootUpdatedEventFilter;
    ...
    "RewardDistributorRewardClaimed(address,address,uint256)"(
      _account?: string | null,
      _rewardToken?: string | null,
      _wad?: null
    ): RewardDistributorRewardClaimedEventFilter;
