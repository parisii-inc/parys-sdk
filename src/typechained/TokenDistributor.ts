...
export declare namespace ITokenDistributor {
  export type TokenDistributorParamsStruct = {
    root: BytesLike;
  ...
  export type TokenDistributorParamsStructOutput = [
    string,
    BigNumber,
    BigNumber,
    BigNumber
...
export interface TokenDistributor extends BaseContract {
  ...
  functions: {
    ...
    canClaim(
      ...
      overrides?: CallOverrides
    ): Promise<[boolean] & { _claimable: boolean }>;
    ...
    claimed(
      _user: string,
      overrides?: CallOverrides
    ): Promise<[boolean] & { _hasClaimed: boolean }>;
