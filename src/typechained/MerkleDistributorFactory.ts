...
export interface MerkleDistributorFactoryInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "deployDistributor",
  ...
  encodeFunctionData(
    functionFragment: "dropDistributorAuth",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getBackTokensFromDistributor",
  ...
  encodeFunctionData(
    functionFragment: "sendTokensToCustom",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "sendTokensToDistributor",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "tokensToDistribute",
    values: [BigNumberish]
  ): string;
...
export type DeployDistributorEventFilter =
  TypedEventFilter<DeployDistributorEvent>;
...
export type SendTokensToDistributorEventFilter =
  TypedEventFilter<SendTokensToDistributorEvent>;
...
export interface MerkleDistributorFactory extends BaseContract {
  ...
  filters: {
    ...
    "DeployDistributor(uint256,address,uint256)"(
      id?: null,
      distributor?: null,
      tokenAmount?: null
    ): DeployDistributorEventFilter;
    DeployDistributor(
      id?: null,
      distributor?: null,
      tokenAmount?: null
    ...
    "SendTokensToDistributor(uint256)"(
      id?: null
    ): SendTokensToDistributorEventFilter;
