...
export declare namespace IPIDController {
  export type ControllerGainsStruct = {
    kp: BigNumberish;
    ki: BigNumberish;
    influenceFactor: BigNumberish;
  };

  export type ControllerGainsStructOutput = [
    BigNumber,
    BigNumber,
    BigNumber
  ] & { kp: BigNumber; ki: BigNumber; influenceFactor: BigNumber };
  ...
  export type DeviationObservationStructOutput = [
    ...
    BigNumber,
    BigNumber
  ] & { timestamp: BigNumber; proportional: BigNumber; integral: BigNumber };
...
export interface IPIDController extends BaseContract {
  ...
  functions: {
    ...
    breaksNoiseBarrier(
      ...
      overrides?: CallOverrides
    ): Promise<[boolean] & { _breaksNb: boolean }>;
    ...
    getGainAdjustedPIOutput(
      _proportionalTerm: BigNumberish,
      _integralTerm: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _piOutput: BigNumber }>;
    ...
    seedProposer(
      overrides?: CallOverrides
    ): Promise<[string] & { _seedProposer: string }>;

    timeSinceLastUpdate(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _timeSinceLastValue: BigNumber }>;
  };
  ...
  controllerGains(
    overrides?: CallOverrides
  ): Promise<IPIDController.ControllerGainsStructOutput>;

  deviationObservation(
    overrides?: CallOverrides
  ): Promise<IPIDController.DeviationObservationStructOutput>;
  ...
  params(
    overrides?: CallOverrides
  ): Promise<IPIDController.PIDControllerParamsStructOutput>;
  ...
  filters: {
    ...
    "UpdateDeviation(int256,int256,int256)"(
      _proportionalDeviation?: null,
      _integralDeviation?: null,
      _deltaIntegralDeviation?: null
    ): UpdateDeviationEventFilter;
    UpdateDeviation(
      _proportionalDeviation?: null,
      _integralDeviation?: null,
      _deltaIntegralDeviation?: null
