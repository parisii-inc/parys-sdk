...
export declare namespace IOracleRelayer {
  ...
  export type OracleRelayerCollateralParamsStructOutput = [
    ...
    BigNumber,
    BigNumber
  ] & { oracle: string; safetyCRatio: BigNumber; liquidationCRatio: BigNumber };
  ...
  export type OracleRelayerParamsStructOutput = [BigNumber, BigNumber] & {
...
export interface IOracleRelayerInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "safeEngine"
      | "systemCoinOracle"
      | "targetRedemptionPrice"
      | "updateCollateralPrice"
      | "updateRedemptionPriceFromOracle"
  ...
  encodeFunctionData(
    functionFragment: "carbonPriceIndexOracle",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "targetRedemptionPrice",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "updateRedemptionPriceFromOracle",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  getEvent(
    nameOrSignatureOrTopic: "UpdateTargetRedemptionPrice"
  ): EventFragment;
}
...
export type UpdateRedemptionPriceEventFilter =
  TypedEventFilter<UpdateRedemptionPriceEvent>;
...
export type UpdateRedemptionRateEventFilter =
  TypedEventFilter<UpdateRedemptionRateEvent>;
...
export type UpdateTargetRedemptionPriceEventFilter =
  TypedEventFilter<UpdateTargetRedemptionPriceEvent>;
...
export interface IOracleRelayer extends BaseContract {
  ...
  functions: {
    ...
    calcRedemptionPrice(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _redemptionPrice: BigNumber }>;

    carbonPriceIndexOracle(
      overrides?: CallOverrides
    ): Promise<[string] & { _carbonPriceIndexOracle: string }>;
    ...
    marketPrice(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _marketPrice: BigNumber }>;
    ...
    redemptionPriceUpdateTime(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _redemptionPriceUpdateTime: BigNumber }>;

    redemptionRate(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _redemptionRate: BigNumber }>;
    ...
    systemCoinOracle(
      overrides?: CallOverrides
    ): Promise<[string] & { _systemCoinOracle: string }>;
  ...
  cParams(
    _cType: BytesLike,
    overrides?: CallOverrides
  ): Promise<IOracleRelayer.OracleRelayerCollateralParamsStructOutput>;
  ...
  params(
    overrides?: CallOverrides
  ): Promise<IOracleRelayer.OracleRelayerParamsStructOutput>;
  ...
  filters: {
    ...
    "UpdateCollateralPrice(bytes32,uint256,uint256,uint256)"(
      _cType?: BytesLike | null,
      _priceFeedValue?: null,
      _safetyPrice?: null,
    ...
    "UpdateRedemptionPrice(uint256)"(
      _redemptionPrice?: null
    ): UpdateRedemptionPriceEventFilter;
    UpdateRedemptionPrice(
      _redemptionPrice?: null
    ): UpdateRedemptionPriceEventFilter;

    "UpdateRedemptionRate(uint256)"(
      _redemptionRate?: null
    ): UpdateRedemptionRateEventFilter;
    UpdateRedemptionRate(
      _redemptionRate?: null
    ): UpdateRedemptionRateEventFilter;

    "UpdateTargetRedemptionPrice(uint256)"(
      _targetPrice?: null
    ): UpdateTargetRedemptionPriceEventFilter;
    UpdateTargetRedemptionPrice(
      _targetPrice?: null
    ): UpdateTargetRedemptionPriceEventFilter;
  };
