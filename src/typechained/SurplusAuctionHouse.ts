...
export declare namespace ISurplusAuctionHouse {
  export type SurplusAuctionHouseParamsStruct = {
  ...
  export type SurplusAuctionHouseParamsStructOutput = [
    BigNumber,
    BigNumber,
    BigNumber,
    string,
...
export interface SurplusAuctionHouse extends BaseContract {
  ...
  params(
    overrides?: CallOverrides
  ): Promise<ISurplusAuctionHouse.SurplusAuctionHouseParamsStructOutput>;
